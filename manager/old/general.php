            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="general.php">عمومی</a></li>
                            <li><a class="" href="buttons.php">دکمه ها</a></li>
                            <li><a class="" href="widget.php">ویجت ها</a></li>
                            <li><a class="" href="slider.php">اسلایدر ها</a></li>
                            <li><a class="" href="font_awesome.php">فونت های شکل دار</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                        ...
                        <ul class="sub">
                            <li><a class="" href="grids.php">گرید</a></li>
                            <li><a class="" href="calendar.php">تقویم</a></li>
                            <li><a class="" href="charts.php">چارت</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                        ...
                        <ul class="sub">
                            <li><a class="" href="form_component.php">کامنت فرم</a></li>
                            <li><a class="" href="form_wizard.php">فرم Wizard</a></li>
                            <li><a class="" href="form_validation.php">ارزیابی فرم</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                        ...
                        <ul class="sub">
                            <li><a class="" href="basic_table.php">جدول ساده</a></li>
                            <li><a class="" href="dynamic_table.php">جدول داینامیک</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="blank.php">صفحه خالی</a></li>
                            <li><a class="" href="profile.php">پروفایل</a></li>
                            <li><a class="" href="invoice.php">فاکتور</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <a class="btn btn-success" data-toggle="modal" href="#myModal">Dialog
                              </a>
                                <a class="btn btn-warning" data-toggle="modal" href="#myModal2">Confirm
                              </a>
                                <a class="btn btn-danger" data-toggle="modal" href="#myModal3">Alert !
                              </a>
                                <!-- Modal -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel-group m-bot20" id="accordion">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Collapsible Group Item #3
                                      </a>
                                    </h4>
                                </div>
