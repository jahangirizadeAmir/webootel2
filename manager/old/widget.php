                                ...
                                <section class="panel">
                                    <header class="panel-heading tab-bg-dark-navy-blue">
                                        <ul class="nav nav-tabs nav-justified ">
                                            ...
                                            <li class="">
                                                <a href="#recent" data-toggle="tab">Recents
                                              </a>
                                            </li>
                                        </ul>
                                    </header>
                                ...
                                <div class="timeline-messages">
                                    ...
                                    <div class="msg-time-chat">
                                        <a href="#" class="message-img">
                                            <img class="avatar" src="../img/chat-avatar.jpg" alt=""></a>
                                    ...
                                    <div class="msg-time-chat">
                                        <a href="#" class="message-img">
                                            <img class="avatar" src="../img/chat-avatar2.jpg" alt=""></a>
                    ...
                    <div class="col-lg-4">
                        <section class="panel">
                            ...
                            <div class="list-group">
                                <a class="list-group-item " href="#">Cras justo odio
                              </a>
