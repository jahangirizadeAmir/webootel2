                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel panel-primary">
                            <header class="panel-heading">لیست ملکهای منقضی من</header>
                            <br>
                            ...
                            <table class="table table-striped border-top" id="sample_1">
                                ...
                                if($_SESSION['level']=='1') {
                                    $selectListAdmin = mysqli_query($conn,"SELECT * FROM estate where expiry='1'");

                                }elseif($_SESSION['level']=='2' || $_SESSION['level']=='0'){
                                        $selectListAdmin = mysqli_query($conn, "SELECT * FROM estate WHERE 
                                        estate.estate_oner='$adminId' AND expiry='1'");
                                }
                                if($_SESSION['level']=='0'){
                                    ...
                                    while ($rowAdminSelect = mysqli_fetch_assoc($selectListAdmin1)){
                                        ...
                                        estate.estate_oner='$adminListId' AND expiry='1' ");
