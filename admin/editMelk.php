    ...
    if (mysqli_num_rows($selectEstate) == 1) {
            ...
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel panel-primary">
                            <header class="panel-heading">
                                ویرایش ملک - کد <?php echo $rowEstate['estate_number']?>
                            </header>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal tasi-form" method="get">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input data-allowZero=true data-precision="0" data-decimal=" " etype="Number" type="text" class="form-control" id="price"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input data-allowZero=true data-precision="0" data-decimal=" " etype="Number" type="text" class="form-control" id="mortgage"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input data-allowZero=true data-precision="0" data-decimal=" " etype="Number" type="text" class="form-control" id="rent"
                               ...
                               <script>
                                    ...
                                    $("#rent").maskMoney();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="checkbox-inline"><input type="checkbox" id="show"
                                                        <?php if ($rowEstate['estateShow'] == '1') echo 'checked' ?>
                                                                                      value="">عدم نمایش در سایت</label>
        ...
        <script>
            ...
            $(document).ready(function() {
                document.title = '<?php echo $rowEstate['estate_userName'] ?>';
            });
