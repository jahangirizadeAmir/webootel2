...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    n.fn = d;
                    n.priority = k;
                    for (var w = f.length - 1; 0 <= w; w--) if (f[w].priority <= k) return f.splice(w + 1, 0, n), {removeListener: u};
                    f.unshift(n)
                }
            ...
            once: function () {
                ...
                return function (k, n, u) {
                    ...
                    if (f) {
                        var w = f.listeners;
                        if (w.length) for (var w = w.slice(0), A, F = 0; F < w.length; F++) {
                            if (f.errorProof) try {
                                A =
                                    w[F].call(this, u, n, b, h)
                            } catch (x) {
                            } else A = w[F].call(this, u, n, b, h);
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            k = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, n = function (a, f) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var n = "\x3c" + k + "\x3e", m = "\x3c/" + k + "\x3e",
                        c = n + c.replace(d, function () {
                            return m + n
                        }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            createClass: function (a) {
                var f = a.$, b = a.base, c = a.privates || a._, k = a.proto;
                a = a.statics;
                !f && (f = function () {
            ...
            normalizeCssText: function (a, f) {
                var b = [], c, k = CKEDITOR.tools.parseCssText(a, !0, f);
            ...
            objectCompare: function (a, f, b) {
                ...
                if (!a && !f) return !0;
                if (!a || !f) return !1;
                for (c in a) if (a[c] != f[c]) return !1;
                if (!b) for (c in f) if (a[c] != f[c]) return !1;
                return !0
            },
            ...
            keystrokeToString: function (a, b) {
                var c = b & 16711680, k =
                    b & 65535, d = CKEDITOR.env.mac, n = [], e = [];
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, k, d = 0; d < b.length; d++) if (c = b[d].split("\x3d"), k = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), k === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            style: {
                parse: {
                    ...
                    margin: function (a) {
                        ...
                        var c = {}, k = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (k.length) {
                            case 1:
                                b([0, 0, 0, 0]);
                                break;
                    ...
                    _findColor: function (a) {
                        var b = [], c = CKEDITOR.tools.array, b =
                            b.concat(a.match(this._rgbaRegExp) || []), b = b.concat(a.match(this._hslaRegExp) || []);
            ...
            array: {
                filter: function (a, b, c) {
                    ...
                    for (var k = [], d = 0; d < a.length; d++) k.push(b.call(c,
                        a[d], d, a));
                    return k
                }, reduce: function (a, b, c, k) {
                    for (var d = 0; d < a.length; d++) c = b.call(k, c, a[d], d, a);
                    return c
                }
            },
            object: {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, k = {"#": 1},
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                var e = a[c];
                if (d) for (var g = -1, h = 0; h < b.childNodes.length; h++) {
    ...
    (function () {
        ...
        function c(a) {
            for (var b = 0, c = 0, f = h[a].length; c < f; c++) b += parseFloat(this.getComputedStyle(h[a][c]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (f) for (var w =
                        0; w < f.length; w++) b.push([a, c[d], f[w]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), w = "BackCompat" == f.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        8 !== CKEDITOR.env.version : 1)) {
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement,
                        x = g.clientTop || d.$.clientTop || 0, m = g.clientLeft || d.$.clientLeft || 0, h = !0;
                ...
                w = a.getWindow();
                d = x(this, w);
                var z = x(a, w), I = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var l = a.$.clientHeight, t = a.$.clientWidth;
                w = d.x - m(this, "left") - z.x || 0;
                e = d.y - m(this, "top") - z.y || 0;
                f = d.x + f + m(this, "right") - (z.x + t) || 0;
                d = d.y + I + m(this, "bottom") - (z.y + l) || 0;
            ...
            getFrameDocument: function () {
                ...
                for (var f = 0; f < c.length; f++) {
                    var d = c[f], w = d.nodeName.toLowerCase(), e;
                    if (!(w in b)) if ("checked" == w && (e = this.getAttribute(w))) a.setAttribute(w, e); else if (!CKEDITOR.env.ie || this.hasAttribute(w)) e = this.getAttribute(w), null === e && (e = d.nodeValue), a.setAttribute(w, e)
                }
                "" !== this.$.style.cssText &&
                ...
                var b = CKEDITOR.instances, c, f, d;
                a = a || void 0 === a;
                for (c in b) if (f = b[c], f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (d = f.editable()) && (d.equals(this) || d.contains(this))) return f;
                return null
            }, find: function (a) {
                var c = d(this);
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, D = c.endOffset, g, l = this.guard, t = this.type,
                J = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var H = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    k = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(D) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !H.equals(a)) && (!k ||
                        !a.equals(k)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var q = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    y = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !q.equals(a)) && (!y || !a.equals(y)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            var v = a ? this._.guardRTL : this._.guardLTR;
            g = l ? function (a, b) {
                return !1 === v(a, b) ? !1 : l(a, b)
            } : v;
            this.current ? f = this.current[J](!1, t, g) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
                (f = 0 < D ? f.getChild(D - 1) : !1 === g(f, !0) ? null : f.getPreviousSourceNode(!0, t, g)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, t, g)))), f && !1 === g(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            h = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), n = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, f = b.getChildCount(); c < f; ++c) if (!u(b.getChild(c))) return !!a;
                return !a
            }
        };
        var f = CKEDITOR.dom.walker.empty(),
            D = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
                var b = {}, c;
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    u(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            function g(a, b, c, f) {
                ...
                if (f && h) return d;
                l || f ? b.append(a.clone(!0, e), c) : (a.remove(), u && b.append(a, c));
                return d
            }

            function m() {
                var a, b, c, f = Math.min(O.length, p.length);
                for (a = 0; a < f; a++) if (b = O[a], c = p[a], !b.equals(c)) return a;
                return a - 1
            }

            function k() {
                var b = C - 1, c = v && B && !t.equals(J);
                b < r - 1 || b < G - 1 || c ? (c ? a.moveToPosition(J,
            ...
            a.optimizeBookmark();
            var h = 0 === b, u = 1 == b, l = 2 == b;
            b = l || u;
            var t = a.startContainer, J = a.endContainer,
                H = a.startOffset, E = a.endOffset, q, y, v, B, L, n;
            if (l && J.type == CKEDITOR.NODE_TEXT && (t.equals(J) || t.type === CKEDITOR.NODE_ELEMENT && t.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E))); else {
                J.type == CKEDITOR.NODE_TEXT ? l ? n = !0 : J = J.split(E) : 0 < J.getChildCount() ? E >= J.getChildCount() ? (J = J.getChild(E - 1), y = !0) : J = J.getChild(E) : B = y = !0;
                t.type == CKEDITOR.NODE_TEXT ? l ? L = !0 : t.split(H) : 0 < t.getChildCount() ? 0 === H ? (t = t.getChild(H), q = !0) : t = t.getChild(H - 1) : v = q = !0;
                for (var O = t.getParents(), p = J.getParents(), C = m(),
                         r = O.length - 1, G = p.length - 1, N = c, P, Y, V, ea = -1, Q = C; Q <= r; Q++) {
                    Y = O[Q];
                    V = Y.getNext();
                    for (Q != r || Y.equals(p[Q]) && r < G ? b && (P = N.append(Y.clone(0, e))) : q ? g(Y, N, !1, v) : L && N.append(a.document.createText(Y.substring(H))); V;) {
                        if (V.equals(p[Q])) {
                            ea = Q;
                            break
                        }
                ...
                N = c;
                for (Q = C; Q <= G; Q++) if (c = p[Q], V = c.getPrevious(), c.equals(O[Q])) b && (N = N.getChild(0)); else {
                    Q != G || c.equals(O[Q]) && G < r ? b && (P = N.append(c.clone(0, e))) : y ? g(c, N, !1, B) : n && N.append(a.document.createText(c.substring(0, E)));
                    if (Q > ea) for (; V;) V = g(V, N, !0);
                    N = P
                }
                l || k()
            }
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id",
                    d + (g ? "C" : "S")));
                g || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(), e.collapse(), e.insertNode(c));
                e = this.clone();
                e.collapse(!0);
                e.insertNode(b);
                ...
                function a(b) {
                    ...
                    if (f.type == CKEDITOR.NODE_TEXT) {
                        ...
                        e = g;
                        f.getText() ? d += e : (g = f.getPrevious(c), e ? (d = e, f = g ? g.getNext() : f.getParent().getFirst()) : (f =
                            f.getParent(), d = g ? g.getIndex(!0) + 1 : 0))
                    }
                    b.container = f;
                    b.offset = d
                }
                ...
                return function (c) {
                    var d = this.collapsed, e = {container: this.startContainer, offset: this.startOffset},
                        m = {container: this.endContainer, offset: this.endOffset};
                    c && (a(e),
                        b(e, this.root), d || (a(m), b(m, this.root)));
                    return {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) if (e = b.getChildCount(),
                    e > d) b = b.getChild(d).getPreviousSourceNode(!0); else if (1 > e) b = b.getPreviousSourceNode(); else {
            ...
            trim: function (a, b) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var g = function (a, b) {
                            ...
                            for (c.guard = function (a) {
                                ...
                                q = f != a ? f.getText() : f.substring(b);
                                if (d.test(q)) return !1
                            }
                            return !0
                        };
                        if (this.collapsed) break;
                        var m = this.getCommonAncestor(), k = this.root, h, u, l, t, J, H = !1, E, q;
                        E = this.startContainer;
                        var y = this.startOffset;
                        E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E, H = !!E), E && ((t = E.getPrevious()) || (l = E.getParent()))) : (y && (t = E.getChild(y - 1) || E.getLast()),
                        t || (l = E));
                        for (l = c(l); l || t;) {
                            if (l && !t) {
                                !J && l.equals(m) && (J = !0);
                                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                                H && "inline" == l.getComputedStyle("display") || (H = !1, J ? h = l : this.setStartBefore(l));
                                t = l.getPrevious()
                            }
                            for (; t;) if (E = !1, t.type == CKEDITOR.NODE_COMMENT) t = t.getPrevious(); else {
                                if (t.type == CKEDITOR.NODE_TEXT) q = t.getText(), d.test(q) && (t = null), E = /[\s\ufeff]$/.test(q); else if ((t.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && t.is("br")) && !t.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[t.getName()]) {
                                    q =
                                        t.getText();
                                    if (d.test(q)) t = null; else for (var y = t.$.getElementsByTagName("*"), v = 0, B; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                        t = null;
                                        break
                                    }
                                    t && (E = !!q.length)
                                } else t = null;
                                E && (H ? J ? h = l : l && this.setStartBefore(l) : H = !0);
                                if (t) {
                                    E = t.getPrevious();
                                    if (!l && !E) {
                                        l = t;
                        ...
                        l = t = null;
                        J = H = !1;
                        E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(y)).length ? H = !0 : (H = !E.getLength(), y == E.getLength() ? (t = E.getNext()) ||
                            (l = E.getParent()) : g(E, y) && (l = E.getParent())) : (t = E.getChild(y)) || (l = E);
                        for (; l || t;) {
                            if (l && !t) {
                                !J && l.equals(m) && (J = !0);
                                if (e ? l.isBlockBoundary() : !k.contains(l)) break;
                                H && "inline" == l.getComputedStyle("display") || (H = !1, J ? u = l : l && this.setEndAfter(l));
                                t = l.getNext()
                            }
                            for (; t;) {
                                E = !1;
                                if (t.type == CKEDITOR.NODE_TEXT) q = t.getText(), g(t, 0) || (t = null), E = /^[\s\ufeff]/.test(q); else if (t.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < t.$.offsetWidth || b && t.is("br")) && !t.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[t.getName()]) {
                                        q =
                                            t.getText();
                                        if (d.test(q)) t = null; else for (y = t.$.getElementsByTagName("*"), v = 0; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                            t = null;
                                            break
                                        }
                                        t && (E = !!q.length)
                        ...
                        h && u && (m = h.contains(u) ? u : h, this.setStartBefore(m), this.setEndAfter(m));
                        break;
                    case CKEDITOR.ENLARGE_BLOCK_CONTENTS:
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        l = new CKEDITOR.dom.range(this.root);
                        k = this.root;
                        l.setStartAt(k, CKEDITOR.POSITION_AFTER_START);
                        ...
                        l = l.lastBackward();
                        L = L || k;
                        this.setStartAt(L, !L.is("br") && (!l && this.checkStartOfBlock() || l && L.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var r = CKEDITOR.dom.walker.whitespaces(), G = CKEDITOR.dom.walker.bookmark();
                        ...
                        l = this.clone();
                        l.collapse();
                        l.setEndAt(k, CKEDITOR.POSITION_BEFORE_END);
                        l = new CKEDITOR.dom.walker(l);
                        l.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : C;
                        L = p = n = null;
                        l = l.lastForward();
                        L = L || k;
                ...
                if (!this.collapsed) {
                    ...
                    var g = this.clone(), m = this.startContainer, k = this.endContainer, h = this.startOffset,
                        u = this.endOffset, l = c = 1;
                    m && m.type == CKEDITOR.NODE_TEXT && (h ? h >= m.getLength() ? g.setStartAfter(m) : (g.setStartBefore(m), c = 0) : g.setStartBefore(m));
                    k && k.type == CKEDITOR.NODE_TEXT && (u ? u >= k.getLength() ? g.setEndAfter(k) : (g.setEndAfter(k), l = 0) : g.setEndBefore(k));
                    var g = new CKEDITOR.dom.walker(g), t = CKEDITOR.dom.walker.bookmark(),
                    ...
                    l && (g.reset(), (g = g[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(g, b ? CKEDITOR.POSITION_BEFORE_END :
            ...
            fixBlock: function (a, b) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, g = d.block, m = null;
                if (!c.blockLimit.equals(d.blockLimit)) return null;
                "br" != a && (e || (e = this.fixBlock(!0, a), g = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), g || (g = this.fixBlock(!1, a)));
                c = e && this.checkStartOfBlock();
                d = g && this.checkEndOfBlock();
                this.deleteContents();
                e && e.equals(g) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END), g = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (g = this.splitElement(e,
                    b || !1), e.is("ul", "ol") || e.appendBogus()));
                return {previousBlock: e, nextBlock: g, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: m}
                ...
                for (var c = 0; a;) {
                    ...
                    var d = a, e = c, g = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (g = d[b ? "getLast" : "getFirst"](u));
                    e || g || (g = d[b ? "getPrevious" : "getNext"](u));
                    a = g
                }
                return !!c
            }, moveToClosestEditablePosition: function (a, b) {
                var c, d = 0, e, g, m = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            moveToElementEditEnd: function (a) {
            ...
            }, getNextEditableNode: e(), getPreviousEditableNode: e(1), _getTableElement: function (a) {
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], g, m, k, h;
                if (c && c.find) for (m = c.find(a), g = 0; g < m.count(); g++) if (c = m.getItem(g), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), h = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
                    d.endNode.equals(c), k && h && e.push(c);
                return e
            }
        };
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = x.startPath();
                    var m = x.endPath(), K = !x.collapsed && c(x, h.block), z = !x.collapsed && c(x, m.block, 1);
                    x.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    K && x.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END);
                    z && x.setEndAt(m.block, CKEDITOR.POSITION_AFTER_START);
                ...
                for (this._.nextNode = null; m;) {
                    var K = 0, z = m.hasAscendant("pre"), I = m.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (I) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (I = 0); else {
                        var t = m.getName();
                        if (CKEDITOR.dtd.$block[t] && "false" == m.getAttribute("contenteditable")) {
                            d = m;
                            b(this, a, d);
                            break
                        } else if (m.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                            if ("br" == t) I = 1; else if (!h && !m.getChildCount() && "hr" != t) {
                                d = m;
                                w = m.equals(x);
                                break
                            }
                            h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != t && (this._.nextNode = m));
                            K = 1
                        } else {
                            if (m.getFirst()) {
                    ...
                    I && !h && (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                    w = (!K || I) && m.equals(x);
                    if (h && !K) for (; !m.getNext(k) && !w;) {
                        t = m.getParent();
                        if (t.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                            K = 1;
                            I = 0;
                            w || t.equals(x);
                    ...
                    I && h.setEndAt(m, CKEDITOR.POSITION_AFTER_END);
                ...
                F && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(g) || A.getNext(g)) && A.remove();
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (l in b) {
                ...
                var r = f;
                r.elements = h(r.elements, /\s+/) || null;
                r.propertiesOnly = r.propertiesOnly || !0 === r.elements;
                var q = /\s*,\s*/, g = void 0;
                for (g in W) {
                    r[g] = h(r[g], q) || null;
                    var p = r, t = O[g], m = h(r[O[g]], q), G = r[g], y = [], B = !0, C = void 0;
                    m ? B = !1 : m = {};
                    for (C in G) "!" == C.charAt(0) && (C = C.slice(1), y.push(C), m[C] = !0, B = !1);
                    for (; C = y.pop();) G[C] =
                        G["!" + C], delete G["!" + C];
                    p[t] = (B ? !1 : m) || null
                }
                r.match = r.match || null;
                d.push(f);
                a.push(f)
            }
            b = e.elements;
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (g in O) {
                    ...
                    m = [];
                    G = void 0;
                    for (G in t) -1 < G.indexOf("*") ? m.push(new RegExp("^" + G.replace(/\*/g, ".*") + "$")) : m.push(G);
                    t = m;
                    t.length && (r[q] = t, p = !1)
                }
                r.nothingRequired = p;
                r.noProperties = !(r.attributes || r.classes || r.styles);
                if (!0 === l.elements ||
                    null === l.elements) e[f ? "unshift" : "push"](l); else for (k in r = l.elements, delete l.elements, r) if (b[k]) b[k][f ? "unshift" : "push"](l); else b[k] = [l]
            }
        }
        ...
        function d(a, c, d, e) {
            if (!a.match || a.match(c)) if (e || k(a, c)) if (a.propertiesOnly || (d.valid = !0), d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)), d.allStyles || (d.allStyles = b(a.styles, c.styles, d.validStyles)), !d.allClasses) {
                ...
                if (a) if (!0 === a) a = !0; else {
                    for (var l = 0, f = c.length, r; l < f; ++l) r = c[l], e[r] ||
                    (e[r] = a(r));
                    a = !1
                } else a = !1;
                d.allClasses = a
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, l = !0 === a, r = b.length; r--;) if (l || a(b[r])) b.splice(r, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function f(a) {
            var b, c, d, e, l = {}, r = 1;
            for (a = B(a); b = a.match(p);) (c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, l["$" + r++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function A(a, b, e, l) {
            var f = 0, q;
            l.toHtml && (b.name = b.name.replace(r, "$1"));
            if (l.doCallbacks && a.elementCallbacks) {
                a:{
                    q = a.elementCallbacks;
                    for (var v = 0, g = q.length, p; v < g; ++v) if (p = q[v](b)) {
                        q = p;
                        break a
                    }
                    q = void 0
            ...
            if (l.doTransform && (q = a._.transformations[b.name])) {
                w(b);
                for (v = 0; v < q.length; ++v) t(a, b, q[v]);
                x(b)
            }
            if (l.doFilter) {
                a:{
                    v = b.name;
                    g = a._;
                    a = g.allowedRules.elements[v];
                    q = g.allowedRules.generic;
                    v = g.disallowedRules.elements[v];
                    ...
                    if (a || q) {
                        w(b);
                        if (v) for (B = 0, C = v.length; B < C; ++B) if (!1 === c(v[B], b, y)) {
                            a = null;
                            break a
                        }
                        if (g) for (B = 0, C = g.length; B < C; ++B) c(g[B], b, y);
                        if (a) for (B = 0, C = a.length; B < C; ++B) d(a[B], b, y, p);
                        if (q) for (B = 0, C = q.length; B < C; ++B) d(q[B], b, y, p);
                        a = y
                    } else a = null
                }
                ...
                var h = a.validStyles;
                q = a.validClasses;
                var v = b.attributes, k = b.styles, g = b.classes;
                p = b.classBackup;
                var J = b.styleBackup, H, N, E = [], y = [], O = /^data-cke-/;
                B = !1;
                delete v.style;
                delete v["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (H in v) C[H] || (O.test(H) ? H == (N = H.replace(/^data-cke-saved-/, "")) || C[N] || (delete v[H], B = !0) : (delete v[H], B = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (H in k) a.allStyles || h[H] ? E.push(H + ":" + k[H]) : B = !0;
                    E.length && (v.style = E.sort().join("; "))
                } else J && (v.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (H = 0; H < g.length; ++H) (a.allClasses || q[g[H]]) && y.push(g[H]);
                    y.length && (v["class"] = y.sort().join(" "));
                    p && y.length < p.split(/\s+/).length && (B = !0)
                } else p && (v["class"] = p);
                B && (f = 1);
        ...
        function I(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                a.name || y.$block[a.name])
        }

        function l(a, b, c) {
            var d = a.name;
            if (y.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (y.$block[d] || "tr" == d) if ("br" == b) a.previous && !I(a.previous) && (b = z(), b.insertBefore(a)), a.next && !I(a.next) && (b = z(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = y[b];
                    for (var l = 0, r = d.length, f; l < r; ++l) if (f = d[l], f.type == CKEDITOR.NODE_ELEMENT && !e[f.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
                ...
                if (e) a.name = b, a.attributes =
                    ...
                    e = a.parent;
                    for (var l = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, q, r = d.length; 0 < r;) f = d[--r], l && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && y.$inline[f.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
                        check: "parent-down",
                        el: v
                    })), v.add(f, 0)) : (v = null, q = y[e.name] || y.span, f.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.type != CKEDITOR.NODE_ELEMENT || q[f.name] || c.push({
                        check: "el-up",
                        el: f
                    }));
                    a.remove()
        ...
        function J(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, l, f, r, v;
            if (a.name != c.element) return !1;
            for (l in d) if ("class" == l) for (c = d[l].split(/\s+/), r = a.classes.join("|"); v = c.pop();) {
                if (-1 == r.indexOf(v)) return !1
            } else if (a.attributes[l] != d[l]) return !1;
            for (f in e) if (a.styles[f] !=
                e[f]) return !1;
            return !0
        }
        ...
        var y = CKEDITOR.dtd, v = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim, L = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], r = this.editor && this.editor.config.protectedSource, v, q = !1,
                    g = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (v = A(e, a, f, g), v & 1) q = !0; else if (v & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, p, t;
                            if (r) for (p = 0; p < r.length; ++p) if ((t = d.match(r[p])) && t[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && A(e, l, c, g);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (var t; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
                for (; p = a.pop();) if (c = p.el, c.parent) switch (t = y[c.parent.name] || y.span, p.check) {
                    case "it":
                        y.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : m(c) || l(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || t[c.name] || l(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || t[c.name] || l(c.parent, d, a)
                }
                return q
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var l = void 0, f = void 0, r = void 0, v = void 0, g = void 0, p = void 0;
                        c = [];
                        for (f = 0; f < b.length; ++f) r = b[f], "string" == typeof r ? (r = r.split(/\s*:\s*/), v = r[0], g = null, p = r[1]) : (v = r.check, g = r.left, p = r.right), l || (l = r, l = l.element ? l.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                            l.left.getDefinition().element), g instanceof CKEDITOR.style && (g = E(g)), c.push({
                            check: v == l ? null : v,
                            left: g,
                            right: "string" == typeof p ? q(p) : p
                        });
                        b = l;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    var r = d.classes;
                    d.name = d.elements;
                    d.classes = r = r ? r.split(/\s*,\s*/) : [];
                    d.styles = u(e);
                    d.attributes = u(d.attributes);
                    d.children = [];
                    r.length && (d.attributes["class"] = r.join(" "));
                    e && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles));
                    e = d
                } else d = a.getDefinition(), e = d.styles, r = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = v(e), r.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = {
                    name: d.element,
                    attributes: r,
                ...
                var r = CKEDITOR.tools.clone(e), q = [], g;
                if (!1 !== b && (g = this._.transformations[e.name])) {
                    for (d =
                             0; d < g.length; ++d) t(this, e, g[d]);
                    x(e)
                }
                A(this, r, q, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < q.length ? !1 : CKEDITOR.tools.objectCompare(e.attributes, r.attributes, !0) ? !0 : !1;
        ...
        N = CKEDITOR.filter.transformationsTools = {
            ...
            }, matchesStyle: J, transform: function (a, b) {
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, l, r, f, v;
                    a.name = c.element;
                    for (l in e) if ("class" == l) for (c =
                                                            a.classes.join("|"), f = e[l].split(/\s+/); v = f.pop();) -1 == c.indexOf(v) && a.classes.push(v); else a.attributes[l] = e[l];
                    for (r in d) a.styles[r] = d[r]
                }
            }
        }
    })();
    ...
    (function () {
        var a, d = function (b) {
            b = b.data;
            var d = b.getKeystroke(), g = this.keystrokes[d], h = this._.editor;
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var k = b.length, n = [], u = [], f = function (a) {
                    c && (h ? c.call(e, a) : c.call(e, n, u))
                };
                if (0 === k) f(!0); else {
                    var D = function (a, b) {
                        (b ? n : u).push(a);
                        ...
                        if (a[b]) D(b, !0); else {
                            ...
                            if (!(1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () {
                                    if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, w(b, !0)
                                } : (f.$.onload = function () {
                                    setTimeout(function () {
                                        w(b, !0)
                                    }, 0)
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, k = {}, n = 0; n < a.length; n++) {
                var u = a[n];
                if (u) if (c[u] || e[u]) k[u] = this.get(u); else {
                    var f = this.getFilePath(u);
                    g.push(f);
                    f in h || (h[f] =
                        []);
                    h[f].push(u)
        ...
        return function (b, c, e) {
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var k = a[f], w = k && k.requires;
                        if (!d[f]) {
                            if (k.icons) for (var A = k.icons.split(","), F = A.length; F--;) CKEDITOR.skin.addIcon(A[F], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[F] + ".png");
                            d[f] = 1
                        }
                        if (w) for (w.split && (w = w.split(",")), k = 0; k < w.length; k++) g[w[k]] || b.push(w[k])
                    }
    ...
    (function () {
        ...
        function D(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var l in c) {
                    var t = c[l], k = t.lang, h = null, O = t.requires, p;
                    CKEDITOR.tools.isArray(O) && (O = O.join(","));
                    if (O && (p = O.match(g))) for (; O = p.pop();) CKEDITOR.error("editor-plugin-required",
                        {plugin: O.replace(",", ""), requiredBy: l});
                    k && !a.lang[l] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""), h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, h) ? h : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), t.langEntries && t.langEntries[h] ? (a.lang[l] = t.langEntries[h], h = null) : f.push(CKEDITOR.getUrl(t.path + "lang/" + h + ".js")));
                    e.push(h);
                    d.push(t)
                }
                CKEDITOR.scriptLoader.load(f, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++) for (var l =
                        0; l < d.length; l++) {
                        var v = d[l];
        ...
        function A(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                var q = a[h], y = q.startContainer.getAscendant("tr", !0);
                c(q) ? (f ||
                (f = y.getAscendant("table").clone(), f.append(y.getAscendant({
                    thead: 1,
                    tbody: 1,
                    tfoot: 1
                }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(y) || (g = y, k = y.clone(), f.append(k)), k.append(d(q))) : e.append(q.cloneContents())
            }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, e = b.length; e--;) c = b[e], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
            }, getCommandKeystroke: function (a) {
                if (a = "string" === typeof a ? this.getCommand(a) : a) {
                    var b = CKEDITOR.tools.object.findKey(this.commands,
                        a), c = this.keystrokeHandler.keystrokes, d;
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > g) if (g = b.substring(g, e), h) h.push(g); else this.onText(g);
            ...
            function (g, h, k) {
                function n(a) {
                    ...
                    if (0 < m.length) for (var c = 0; c < m.length; c++) {
                        var d = m[c], e = d.name, f = CKEDITOR.dtd[e], l = z.name && CKEDITOR.dtd[z.name];
                        l && !l[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == z.name && (D(z, z.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = z, z = d, m.splice(c, 1), c--)
                    }
                }

                function u() {
                    for (; K.length;) D(K.shift(), z)
                }
                ...
                function D(b, c, d) {
                    c = c || z || x;
                    var e = z;
                    void 0 === b.previous && (w(c, b) && (z = c, F.onTagOpen(k, {}), b.returnPoint = c = z), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (l = !1), "textarea" == b.name && (I = !1));
                    b.returnPoint ? (z = b.returnPoint, delete b.returnPoint) : z = d ? c : e
                }
                ...
                var F = new CKEDITOR.htmlParser,
                    ...
                    m = [], K = [], z = x, I = "textarea" == x.name, l = "pre" == x.name;
                F.onTagOpen = function (e, f, g, k) {
                    ...
                    if (a(f)) m.push(f); else {
                        ...
                        if ("br" == e) K.push(f); else {
                            for (; !(k = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || z.isUnknown || k[e]);) if (z.isOptionalClose) F.onTagClose(g); else if (e in b && g in b) g = z.children, (g = g[g.length - 1]) && "li" == g.name || D(g = new CKEDITOR.htmlParser.element("li"), z), !f.returnPoint && (f.returnPoint = z), z = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = z), z = z.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(z), z.parent) D(z, z.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            n(e);
                ...
                F.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [], e = z; e != x && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != x) {
                ...
                F.onText = function (a) {
                    if (!(z._.hasInlineStarted && !K.length || l || I) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                    var b = z.name,
                        f = b ? CKEDITOR.dtd[b] || (z._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!I && !f["#"] && b in d) F.onTagOpen(e[b] || ""), F.onText(a); else {
                        u();
                        n();
                        l || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (w(z, a)) this.onTagOpen(k, {}, 0, 1);
                        z.add(a)
                    }
                };
                F.onCDATA =
                ...
                F.onComment = function (a) {
                    u();
                    n();
                    z.add(new CKEDITOR.htmlParser.comment(a))
                };
                F.parse(g);
                for (u(); z != x;) D(z, z.parent, 1);
                f(x);
                return x
            };
    ...
    (function () {
        ...
        function d(b, c, d, g) {
            var h, k;
            for (h in c) (k = b[h]) || (k = b[h] = new a), k.add(c[h], d, g)
        }
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g, h = 0; 3 > h; h++) if (g = d[h]) {
                        g = g.exec(a, c, this);
                        if (!1 === g) return null;
        ...
        a.prototype = {
            add: function (a, c, d) {
                this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: d})
                                  ...
                                  c, d) {
                for (var g = [this.findIndex(c), 0], h = 0, k = a.length; h < k; h++) g.push({
                    value: a[h],
                    priority: c,
                    options: d
                });
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), h = this.rules, k = h.length, n, u, f, D;
                for (D = 0; D < k; D++) if (d && (n = c.type, u = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
                        a.nestedEditable && f.options.excludeNestedEditable)) {
                    f = f.value.apply(null, g);
                    if (!1 === f || d && f && (f.name != u || f.type != n)) return f;
                    null != f && (g[0] = c = f)
                }
                return c
            }, execOnName: function (a, c) {
                for (var d = 0, g = this.rules, h = g.length, k; c && d < h; d++) k = g[d], a.nonEditable && !k.options.applyToAll || a.nestedEditable && k.options.excludeNestedEditable || (c = c.replace(k.value[0], k.value[1]));
                return c
            }
        }
    })();
    (function () {
        function a(a, d) {
            ...
            function v(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var l = [], r = b(e), v, p;
                        if (r) for (q(r, 1) && l.push(r); r;) g(r) && (v = c(r)) && q(v) && ((p = c(v)) && !g(p) ? l.push(v) : (f(y).insertAfter(v), v.remove())), r = r.previous;
                        for (r = 0; r < l.length; r++) l[r].remove();
                        if (l = !a || !1 !== ("function" == typeof d ? d(e) : d)) y || CKEDITOR.env.needsBrFiller ||
                        e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (l = b(e), l = !l || "form" == e.name && "input" == l.name) : l = !1 : l = !1;
                        l && e.add(f(a))
                    }
                }
            }
            ...
            var p = {elements: {}}, y = "html" == d, B = CKEDITOR.tools.extend({}, l), C;
            for (C in B) "#" in z[C] || delete B[C];
            for (C in B) p.elements[C] = v(y, a.config.fillEmptyBlocks);
            p.root = v(y, !1);
            ...
            return a.replace(q,
                function (a, b, c) {
                    return "\x3c" + b + c.replace(y, function (a, b) {
                        return v.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a
                    }) + "\x3e"
                })
        }
        ...
        function w(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) {
                    return "\x3c!--" + K + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e"
                })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            c.addRules(t);
            c.addRules(J, {applyToAll: !0});
            c.addRules(a(b, "data"), {applyToAll: !0});
            e.addRules(H);
            e.addRules(E, {applyToAll: !0});
            e.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = x(c, b), c = f(c, L), c = u(c), c = f(c, B), c = c.replace(O, "$1cke:$2"),
                    c = c.replace(C, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return e.fire("toHtml", {
                    ...
                    filter: l || e.filter, enterMode: v || e.enterMode, protectedWhitespaces: g
                }).dataValue
        ...
        var m = /(?:&nbsp;|\xa0)$/, K = "{cke_protected}", z = CKEDITOR.dtd,
            I = "caption colgroup col thead tfoot tbody".split(" "), l = CKEDITOR.tools.extend({}, z.$blockLimit,
            z.$block), t = {elements: {input: k, textarea: k}}, J = {
        ...
        var q = /<(a|area|img|input|source)\b([^>]*)>/gi,
            y = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, v = /^(href|src|name)$/i,
            B = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            L = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, W = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            O = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            p = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, C = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var n, u;
                for (n in h) {
                    for (k = h[n]; ;) if (u = a.onAttributeName(b, n)) if (u != n) delete h[n], n = u; else break; else {
                        delete h[n];
                        break
                    }
                    u && (!1 === (k = a.onAttribute(b, d, u, k)) ? delete h[u] :
                        h[u] = k)
                }
                ...
                b && this.filter(b);
                var g = this.name, h = [], k = this.attributes, n, u;
                a.openTag(g, k);
                for (n in k) h.push([n, k[n]]);
                a.sortAttributes && h.sort(d);
                n = 0;
                for (u = h.length; n < u; n++) k = h[n], a.attribute(k[0], k[1]);
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    var k = d.checkDirty(), h = d._.previousModeData, n, u = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = n = d.getData(1);
                    "source" == d.mode && h == n && (d.fire("lockSnapshot", {forceUpdate: !0}), u = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var k = this.container, n = this.ui.space("contents"),
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, q = g.getRanges()[0], y;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, e)) g.appendBogus(), y = CKEDITOR.env.ie;
            h(b, e.block, f) && q.collapsed && !q.getCommonAncestor().isReadOnly() && (e = q.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
            (b = q.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), y = 1, a.cancel());
            y && q.select()
        }
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
                        ...
                        thead: 1,
                        tfoot: 1
                    }) ? m(b) : b.startContainer.is(CKEDITOR.dtd.$list) && K(b));
                    var g, v;
                    if (f) for (; (g = b.getCommonAncestor(0, 1)) && (v = CKEDITOR.dtd[g.getName()]) && (!v || !v[e]);) g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ?
                        "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    if (!this.is("textarea")) {
                        ...
                        var k = a.config.contentsLangDirection;
                        this.getDirection(1) != k && this.changeAttr("dir", k);
                        var h = CKEDITOR.getCss();
                        if (h) {
                            var k = e.getHead(), q = k.getCustomData("stylesheet");
                            q ? h != q.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? q.$.styleSheet.cssText = h : q.setText(h)) : (h = e.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), k.setCustomData("stylesheet",
                                h), h.data("cke-temp", 1))
                        }
                        k = e.getCustomData("stylesheet_ref") || 0;
                        e.setCustomData("stylesheet_ref", k + 1);
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in
                                    y) {
                                    var e, q = b.getRanges()[0], p = q.startPath(), C, r, k, c = 8 == c;
                                    CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (e = b.getSelectedElement()) || (e = g(b)) ? (a.fire("saveSnapshot"), q.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e.remove(), q.select(), a.fire("saveSnapshot"), d = 1) : q.collapsed && ((C = p.block) && (k = C[c ? "getPrevious" : "getNext"](f)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("table") && q[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"), q[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && C.remove(), q["moveToElementEdit" +
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) {
                            b.data.getKeystroke() in y && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                        });
                        ...
                        CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) {
                            if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(F, ""))) {
                                var c = a.createRange();
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (c in y && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                } else c = d, p = b.block, d = c.endPath().block, p && d && !p.equals(d) ? (a.fire("saveSnapshot"), (e = p.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(p, !1), b.lastElement.mergeSiblings(), u(p, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        x = function () {
            ...
            function b(c, d) {
                var e, f, q, g, y = [], k = d.range.startContainer;
                e = d.range.startPath();
                for (var k = v[k.getName()], h = 0, B = c.getChildren(), n = B.count(), L = -1, u = -1, E = 0, H = e.contains(v.$list); h < n; ++h) e = B.getItem(h), a(e) ? (q = e.getName(), H && q in CKEDITOR.dtd.$list ? y = y.concat(b(e, d)) : (g = !!k[q],
                "br" != q || !e.data("cke-eol") || h && h != n - 1 || (E = (f = h ? y[h - 1].node : B.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && v.$block[f.getName()]), -1 != L || g || (L = h), g || (u = h), y.push({
                    isElement: 1,
                    isLineBreak: E,
                    ...
                    name: q,
                    allowed: g
                }), f = E = 0)) : y.push({isElement: 0, node: e, allowed: 1});
                -1 < L && (y[L].firstNotAllowed = 1);
                -1 < u && (y[u].lastNotAllowed = 1);
                return y
            }

            function d(b, c) {
                var e = [], f = b.getChildren(), q = f.count(), g, y = 0, k = v[c], h = !b.is(v.$inline) || b.is("br");
                for (h && e.push(" "); y < q; y++) g =
                    f.getItem(y), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g);
                h && e.push(" ");
                return e
            }
            ...
            function q(b, c, d, e) {
                ...
                (g.moveChildren(v), g.remove(), q(b, c, d, e))
            }
            ...
            var v = CKEDITOR.dtd, B = {
                ...
                dl: 1,
                blockquote: 1
            }, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, u = CKEDITOR.tools.extend({},
                v.$inline);
            delete u.br;
            return function (B, p, C, r) {
                var G = B.editor, N = !1;
                "unfiltered_html" == p && (p = "html", N = !0);
                if (!r.checkReadOnly()) {
                    var P = (new CKEDITOR.dom.elementPath(r.startContainer, r.root)).blockLimit || r.root;
                    B = {
                        type: p,
                        dontFilter: N,
                        editable: B,
                    ...
                    B.endPath = P = new CKEDITOR.dom.elementPath(p.endContainer);
                    if (!p.collapsed) {
                        var G = P.block || P.blockLimit, x = p.getCommonAncestor();
                        G && !G.equals(x) && !G.contains(x) && p.checkEndOfBlock() && B.zombies.push(G);
                        p.deleteContents()
                    }
                    for (; (w = e(p)) && a(w) && w.isBlockBoundary() && N.contains(w);) p.moveToPosition(w, CKEDITOR.POSITION_BEFORE_END);
                    q(p, B.blockLimit, N, P);
                    ...
                    m = p.createBookmark();
                    (G = m.startNode.getPrevious(c)) && a(G) && f(G) && r.push(G);
                    (G = m.startNode.getNext(c)) && a(G) && f(G) && r.push(G);
                    for (G = m.startNode; (G = G.getParent()) && f(G);) r.push(G);
                    p.moveToBookmark(m);
                    if (m = C) {
                        m = B.range;
                        if ("text" == B.type && B.inlineStylesRoot) {
                            ...
                            for (r = B.inlineStylesRoot.getParent(); !w.equals(r);) p = p.appendTo(w.clone()), w = w.getParent();
                            C = p.getOuterHtml().split("{cke-peak}").join(C)
                        }
                        w =
                            B.blockLimit.getName();
                        if (/^\s+|\s+$/.test(C) && "span" in CKEDITOR.dtd[w]) {
                            var D = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            C = D + C + D
                        }
                        C = B.editor.dataProcessor.toHtml(C, {
                            context: null,
                            fixForBody: !1,
                            protectedWhitespaces: !!D,
                            dontFilter: B.dontFilter,
                            filter: B.editor.activeFilter,
                            enterMode: B.editor.activeEnterMode
                        });
                        w = m.document.createElement("body");
                        w.setHtml(C);
                        D && (w.getFirst().remove(), w.getLast().remove());
                        if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus())) a:{
                            var A;
                            if (1 ==
                                w.getChildCount() && a(A = w.getFirst()) && A.is(n) && !A.hasAttribute("contenteditable")) {
                                D = A.getElementsByTag("*");
                                m = 0;
                                for (r = D.count(); m < r; m++) if (p = D.getItem(m), !p.is(u)) break a;
                    ...
                    if (m) {
                        ...
                        var I, K;
                        p = A.startContainer;
                        var N = B.endPath.elements[0], X, P = N.getPosition(p),
                            x = !!N.getCommonAncestor(p) && P != CKEDITOR.POSITION_IDENTICAL && !(P & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        p = b(B.dataWrapper, B);
                        for (g(p, A); r < p.length; r++) {
                            P = p[r];
                            if (M = P.isLineBreak) {
                                M = A;
                                I = w;
                                var S = void 0, Z = void 0;
                                P.hasBlockSibling ? M = 1 : (S = M.startContainer.getAscendant(v.$block, 1)) && S.is({
                                    div: 1,
                                    p: 1
                                }) ? (Z = S.getPosition(I), Z == CKEDITOR.POSITION_IDENTICAL || Z == CKEDITOR.POSITION_CONTAINS ? M = 0 : (I = M.splitElement(S), M.moveToPosition(I, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0
                            }
                            if (M) C = 0 < r; else {
                                M = A.startPath();
                                !P.isBlock && h(B.editor, M.block, M.blockLimit) && (T = k(B.editor)) && (T = m.createElement(T), T.appendBogus(), A.insertNode(T),
                                CKEDITOR.env.needsBrFiller && (z = T.getBogus()) && z.remove(), A.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END));
                                if ((M = A.startPath().block) && !M.equals(F)) {
                                    if (z = M.getBogus()) z.remove(), D.push(M);
                                    F = M
                                }
                                P.firstNotAllowed && (G = 1);
                                if (G && P.isElement) {
                                    M = A.startContainer;
                                    for (I = null; M && !v[M.getName()][P.name];) {
                                        if (M.equals(w)) {
                                            M = null;
                                            break
                                        }
                                    ...
                                    if (M) I && (K = A.splitElement(I), B.zombies.push(K), B.zombies.push(I)); else {
                                        I = w.getName();
                                        X = !r;
                                        M = r == p.length - 1;
                                        I = d(P.node, I);
                                        for (var S = [], Z = I.length, aa = 0, ca = void 0,
                                                 da = 0, U = -1; aa < Z; aa++) ca = I[aa], " " == ca ? (da || X && !aa || (S.push(new CKEDITOR.dom.text(" ")), U = S.length), da = 1) : (S.push(ca), da = 0);
                                        M && U == S.length && S.pop();
                                        X = S
                                    }
                                }
                                if (X) {
                                    for (; M = X.pop();) A.insertNode(M);
                                    X = 0
                                } else A.insertNode(P.node);
                                P.lastNotAllowed && r < p.length - 1 && ((K = x ? N : K) && A.setEndAt(K, CKEDITOR.POSITION_AFTER_START), G = 0);
                                A.collapse()
                            }
                        }
                        1 != p.length ? z = !1 : (z = p[0], z = z.isElement && "false" == z.node.getAttribute("contenteditable"));
                        z && (C = !0, M = p[0].node, A.setStartAt(M, CKEDITOR.POSITION_BEFORE_START), A.setEndAt(M, CKEDITOR.POSITION_AFTER_END));
                        B.dontMoveCaret = C;
                        B.bogusNeededBlocks = D
                    }
                    z = B.range;
                    var R;
                    K = B.bogusNeededBlocks;
                    for (X = z.createBookmark(); F = B.zombies.pop();) F.getParent() && (T = z.clone(), T.moveToElementEditStart(F), T.removeEmptyBlocksAtEnd());
                    if (K) for (; F = K.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(z.document.createText(" "));
                    for (; F = B.mergeCandidates.pop();) F.mergeSiblings();
                    z.moveToBookmark(X);
                    if (!B.dontMoveCaret) {
                        for (F = e(z); F && a(F) && !F.is(v.$empty);) {
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(),
                            g = e.contains(CKEDITOR.dtd.$list), k = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var k = f.contains(CKEDITOR.dtd.$list), h = g.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        var e =
                                [], f, g = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d),
                            h = c.endPath().contains(d), p = {};
                        g.guard = function (a, g) {
                            ...
                            if (g && k && a.equals(k)) f = c.clone(), f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && h && a.equals(h)) f = c.clone(), f.setStartAt(h, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                                if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h ||
                                    b(a, h));
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), k = g.clone(), h, l, p = g.getCommonAncestor();
    ...
    (function () {
        function a(a, b) {
            ...
            if (c) return !1;
            for (d = 0; d < a.length; d++) if (c = a[d]._getTableElement(), !c) return !1;
            return !0
        }
        ...
        function c(a) {
            var c = this.root.editor, d = c.getSelection(1);
            this.reset();
            I = !0;
        ...
        function e() {
            ...
            if (b) {
                ...
                if (!(d = !c) && (d = !c.isHidden())) {
                    d = b;
                    var e = c.getRanges(), f = d.getRanges(),
                        g = e.length && e[0]._getTableElement() && e[0]._getTableElement().getAscendant("table",
                            !0),
                        ...
                        r = 1 === e.length && e[0].collapsed, f = a(e, !!CKEDITOR.env.webkit) && a(f);
                    g = g && k ? g.equals(k) || k.contains(g) : !1;
                    g && (r || f) ? (p && !h && d.selectRanges(e), d = !0) : d = !1;
                    d = !d
                }
                d && (b.reset(), b = 0)
            }
        ...
        function h() {
            l = null;
            t && (CKEDITOR.tools.setTimeout(e, 0, this), t = !1)
        }
        ...
        function n(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(k, null, c), e = a.getNextNode(k, null, c);
        ...
        function F(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d = c.startContainer;
                    e = c.endContainer;
                    var f = c.startOffset, g = c.endOffset, p = c.clone();
        ...
        var x = "function" != typeof window.getSelection, m = 1, K = CKEDITOR.tools.repeat("​", 7),
            z = new RegExp(K + "( )?", "g"), I, l, t, J = CKEDITOR.dom.walker.invisible(1), H = function () {
                function a(b) {
                    return function (a) {
                ...
                function b(a) {
                    return function (b) {
                        ...
                        (e = d.moveToClosestEditablePosition(b.selected, a)) || (e = d.moveToClosestEditablePosition(b.selected,
                            !a));
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                function a() {
                    n = new CKEDITOR.dom.selection(c.getSelection());
                    n.lock()
                }
                ...
                function b() {
                    ...
                    "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == k.$ && c.select()
                }
                ...
                var k = c.document, p = CKEDITOR.document,
                    h = c.editable(), r = k.getBody(), l = k.getDocumentElement(), q = h.isInline(), y, n;
                CKEDITOR.env.gecko && h.attachListener(h, "focus", function (a) {
                    a.removeListener();
                    0 !== y && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == h.$ && (a = c.createRange(), a.moveToElementEditStart(h), a.select())
                }, null, null, -2);
                h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    y && CKEDITOR.env.webkit && (y = c._.previousActive && c._.previousActive.equals(k.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop !=
                    h.$.scrollTop && (h.$.scrollTop = c._.previousScrollTop);
                    c.unlockSelection(y);
                    y = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || q) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    c.lockSelection(n);
                    y = 1
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    h.attachListener(h, "mousedown", function (a) {
                        2 ==
                        a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (m = c.window.getScrollPosition()))
                    });
                    h.attachListener(h, "mouseup", function (a) {
                        2 == a.data.$.button && m && (c.document.$.documentElement.scrollLeft = m.x, c.document.$.documentElement.scrollTop = m.y);
                        m = null
                    });
                    if ("BackCompat" != k.$.compatMode) {
                ...
                h.attachListener(h, "selectionchange", e, c);
                h.attachListener(h, "keyup", g, c);
                ...
                if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    h.attachListener(k.getDocumentElement(),
                        "mouseup", function () {
                            t && g.call(c);
                            t = 0
                        })
                } else h.attachListener(CKEDITOR.env.ie ? h : k.getDocumentElement(), "mouseup", g, c);
                CKEDITOR.env.webkit && h.attachListener(k, "keydown", function (a) {
                ...
                h.attachListener(h, "keydown", A(c), null, null, -1)
            });
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
            ...
            _createFillingCharSequenceNode: u,
            FILLING_CHAR_SEQUENCE: K
        });
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                    ...
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && E[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                }
                return a.type = b
            }, getRanges: function () {
                var a = x ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                                 l = e.length - 1, q = -1, n, m; k <= l;) if (q = Math.floor((k + l) / 2), f = e[q], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n) l = q - 1; else if (0 > n) k = q + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == q || q == e.length - 1 && 0 > n) {
                            ...
                            CKEDITOR.NODE_TEXT && (m = g, h -= g.nodeValue.length);
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    function () {
                        for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && E[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d && d.$
                    });
                ...
                var b = this.getNative(), b = x ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                if (this.isLocked) {
                    if (b) var d = this.getSelectedElement(), e = this.getRanges(), f = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                ...
                var d = this.root.editor, e = d && d._.hiddenSelectionContainer;
                this.reset();
                if (e) for (var e = this.root, g, h = 0; h < b.length; ++h) g =
                ...
                if (b.length) if (this.isLocked) {
                    ...
                    a:{
                        var p, C;
                        if (1 == b.length && !(C = b[0]).collapsed && (l = C.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (C = C.clone(), C.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (p = C.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (l = p), "false" == l.getAttribute("contenteditable"))) break a;
                        l = void 0
                    }
                    if (l) this.fake(l); else if (d && d.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && a(b) && !I) c.call(this, b); else {
                        if (x) {
                            ...
                            b = d.collapsed;
                            var r, G, m;
                            if ((e = d.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in E && (!e.is("a") || !e.getText())) try {
                            ...
                            if (d.startContainer.type ==
                                CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in C || d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in C) d.shrink(CKEDITOR.NODE_ELEMENT, !0), b = d.collapsed;
                            m = d.createBookmark();
                            C = m.startNode;
                            b || (k = m.endNode);
                            ...
                            k ? (l = d.document.$.body.createTextRange(), l.moveToElementText(k.$), m.setEndPoint("EndToEnd", l), m.moveEnd("character", -1)) : (r = C.getNext(p), G = C.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(l)) &&
                                (G || !C.hasPrevious() || C.getPrevious().is && C.getPrevious().is("br")), G = d.document.createElement("span"), G.setHtml("\x26#65279;"), G.insertBefore(C), r && d.document.createText("﻿").insertBefore(C));
                            d.setStartBefore(C);
                            C.remove();
                            b ? (r ? (m.moveStart("character", -1), m.select(), d.document.$.selection.clear()) : m.select(), d.moveToPosition(G, CKEDITOR.POSITION_BEFORE_START), G.remove()) : (d.setEndBefore(k), k.remove(), m.select())
                        } else {
                            k = this.getNative();
                            if (!k) return;
                            ...
                            for (m = 0; m < b.length; m++) {
                                if (m <
                                    b.length - 1 && (r = b[m], G = b[m + 1], l = r.clone(), l.setStart(r.endContainer, r.endOffset), l.setEnd(G.startContainer, G.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) {
                                ...
                                d.collapsed && CKEDITOR.env.webkit && n(d) && (l = u(this.root), d.insertNode(l), (r = l.getNext()) && !l.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" ==
                                r.getName() ? (f(this.root), d.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : d.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
                                G.setStart(d.startContainer.$, d.startOffset);
                                try {
                                    G.setEnd(d.endContainer.$, d.endOffset)
                                } catch (t) {
                                    if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), G.setEnd(d.endContainer.$, d.endOffset); else throw t;
                                }
                                k.addRange(G)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed) f = K(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var u = c.createBookmark(), w = u.startNode, t = u.endNode, q = w, v;
                if (!l) {
                    var x = c.getCommonAncestor(), l = a(w, x), x = a(t, x);
                ...
                for (q.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    ...
                    if (q.equals(t)) q = null, l = !0; else {
                        var A = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
                            x = A && "false" == q.getAttribute("contentEditable"), D = A &&
                            q.getAttribute("data-nostyle");
                        if (A && q.data("cke-bookmark")) {
                            q = q.getNextSourceNode(!0);
                            continue
                        }
                        if (x && m && CKEDITOR.dtd.$block[A]) for (var z = q, y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) {
                            var E = y[I], J = CKEDITOR.filter.instances[E.data("cke-filter")];
                            if (J ? J.check(this) : 1) z.selectNodeContents(E), b.call(this, z)
                        }
                        y = A ? !n[A] || D ? 0 : x && !m ? 0 : d(q, t, h, W) : 1;
                        if (y) if (E = q.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0; else {
                            if (v ||
                                A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(t) | W) != W || (v = c.clone(), v.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                for (var A = q, L; (l = !A.getNext(B)) && (L = A.getParent(), n[L.getName()]) && d(L, w, h, O);) A = L;
                                v.setEndAfter(A)
                            }
                        } else l = !0;
                        q = q.getNextSourceNode(D || x)
                    }
                    if (l && v && !v.collapsed) {
                        for (var l = K(this, f), x = l.hasAttributes(), D = v.getCommonAncestor(), A = {}, y = {}, E = {}, H = {}, U, R, ba; l && D;) {
                            if (D.getName() == g) {
                                for (U in h.attributes) !H[U] && (ba = D.getAttribute(R)) &&
                                (l.getAttribute(U) == ba ? y[U] = 1 : H[U] = 1);
                                for (R in h.styles) !E[R] && (ba = D.getStyle(R)) && (l.getStyle(R) == ba ? A[R] = 1 : E[R] = 1)
                            }
                            D = D.getParent()
                        }
                        for (U in y) l.removeAttribute(U);
                        for (R in A) l.removeStyle(R);
                        x && !l.hasAttributes() && (l = null);
                        l ? (v.extractContents().appendTo(l), v.insertNode(l), F.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), v.extractContents().appendTo(l), v.insertNode(l), F.call(this, l), l.remove(!0));
                        v = null
                    }
                }
                c.moveToBookmark(u);
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(n.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) {
                    ...
                    u.checkElementRemovable(h, !0) && (e = h)
                }
                for (g = 0; g < c.elements.length; g++) {
                    h = c.elements[g];
                    if (h == c.block || h == c.blockLimit) break;
                    u.checkElementRemovable(h, !0) && (f = h)
                }
                f && n.breakParent(f);
                e && d.breakParent(e)
            }
        ...
        function k(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = K(this, e, d), u(d, f));
            a.moveToBookmark(b)
        }
        ...
        function n(a) {
            ...
            (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), u(d, e)) : A.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function u(a, b) {
            ...
            if (d) {
                var c = b, k;
                (k = c.getPrevious(L)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = D(k.getHtml(), /\n$/, "") + "\n\n" + D(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function m(a, b) {
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(L), d = a.getNext(L);
        ...
        function I(a,
                   b) {
            for (var c in a) a[c] = a[c].replace(v, function (a, c) {
                return b[c]
            })
        }
        ...
        var E = {
                ...
                audio: 1,
                video: 1
            }, y = /\s*(?:;\s*|$)/, v = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1),
        ...
        CKEDITOR.style = function (a, b) {
            ...
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                a.element : "*";
            this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : q[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                if (a instanceof
                    CKEDITOR.dom.document) return H.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
                ...
                if ("string" == typeof this.element ?
                    ...
                    if (c._length) {
                        for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? J(c[h], d) : c[h] == d) {
                            if (!b) return !0
                        } else if (b) return !1;
                        if (b) return !0
                    } else return !0
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            ...
            do if (n.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (n.equals(e)) break;
                if (!h && (u = n.getName(),
                        "true" == n.getAttribute("contenteditable") ? h = n : !g && d[u] && (g = n), a[u])) {
                    if (u = !g && "div" == u) {
                        a:{
                            u = n.getChildren();
                            for (var f = 0, D = u.count(); f < D; f++) {
                                var w = u.getItem(f);
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) {
            ...
            var c = 0, e;
            "string" == typeof a && (e = function (b) {
                return b.getName() == a
            });
            a instanceof CKEDITOR.dom.element ? e = function (b) {
                return b.equals(a)
            } : CKEDITOR.tools.isArray(a) ? e = function (b) {
                return -1 < CKEDITOR.tools.indexOf(a, b.getName())
            } : "function" == typeof a ? e = a : "object" == typeof a && (e = function (b) {
                return b.getName() in
                    a
            });
            var g = this.elements, h = g.length;
            d && (b ? c += 1 : --h);
            b && (g = Array.prototype.slice.call(g, 0), g.reverse());
            for (; c < h; c++) if (e(g[c])) return g[c];
            return null
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(), e = this.getDocument(),
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], k = d ? "endOffset" : "startOffset",
                ...
                return {
                    getNextRange: function (h) {
                        ...
                        if (k && 1 < a.length) {
                            ...
                            if (h) for (var u = 0; a[g + u + 1];) {
                                var f = k.document;
                                h = 0;
                                n = f.getById(d[u].endNode);
                                for (f = f.getById(d[u + 1].startNode); ;) {
                                    n =
                                        n.getNextSourceNode(!1);
                                    if (f.equals(n)) h = 1; else if (c(n) || n.type == CKEDITOR.NODE_ELEMENT && n.isBlockBoundary()) continue;
                                    break
                                }
                                if (!h) break;
                                u++
                            }
                            for (k.moveToBookmark(d.shift()); u--;) n = a[++g], n.moveToBookmark(d.shift()), k.setEnd(n.endContainer, n.endOffset)
                        }
                        return k
                    }
                }
    ...
    (function () {
        ...
        var h = "cke_ui_color", k = [], n = /\$color/g;
...
*/
    ...
    (function () {
            ...
            commitContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [], c = a.label ? ' title\x3d"' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {
                        ...
                        }, b), d = this._.contents[a.id] = {}, f = e.getChild(),
        ...
        var aa = {
            ...
            for (var e = 0, d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = D(d[c],
                    b, c))) return d;
            return null
        ...
        (function () {
            var a = /^([a]|[^a])+$/, b = /^\d*$/, c = /^\d*(?:\.\d+)?$/, e = /^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/,
                d = /^(((\d*(\.\d+))|(\d*))(px|em|ex|in|cm|mm|pt|pc|\%)?)?$/i, f = /^(\s*[\w-]+\s*:\s*[^:;]+(?:;|$))*$/;
    ...
    Notification.prototype = {
        show: function () {
            ...
            f && (c.removeClass(this._getClass()), c.removeAttribute("aria-label"),
                this.type = f, c.addClass(this._getClass()), c.setAttribute("aria-label", this.type), "progress" != this.type || e ? "progress" != this.type && e && e.remove() : (e = this._createProgressElement(), e.insertBefore(d)));
        ...
        hide: function () {
            ...
            if ("number" == typeof this.duration) a = this.duration; else if ("info" == this.type || "success" == this.type) a = "number" == typeof this.editor.config.notification_duration ? this.editor.config.notification_duration :
                5E3;
    ...
    Area.prototype = {
        add: function (b) {
            ...
            var a = this.element, c = this.editor, d = c.ui.contentsElement.getClientRect(),
                e = c.ui.contentsElement.getDocumentPosition(), f, l, r = a.getClientRect(), m,
                g = this._notificationWidth, h = this._notificationMargin;
            m = CKEDITOR.document.getWindow();
            var p = m.getScrollPosition(), q = m.getViewPaneSize(), t = CKEDITOR.document.getBody(),
                u = t.getDocumentPosition(), k = CKEDITOR.tools.cssLength;
            ...
            f && f.isVisible() && l.bottom > d.top && l.bottom < d.bottom - r.height ? a.setStyles({
                position: "fixed",
                top: k(l.bottom)
            }) : 0 < d.top ? a.setStyles({
                position: "absolute",
                top: k(e.y)
            }) : e.y + d.height - r.height > p.y ? a.setStyles({
                position: "fixed",
                top: 0
            }) : a.setStyles({position: "absolute", top: k(e.y + d.height - r.height)});
            var n = "fixed" == a.getStyle("position") ? d.left : "static" != t.getComputedStyle("position") ? e.x - u.x : e.x;
            d.width < g + h ? e.x + g + h > p.x + q.width ? b() : a.setStyle("left", k(n)) : e.x + g + h > p.x + q.width ? a.setStyle("left", k(n)) : e.x + d.width / 2 + g / 2 + h > p.x + q.width ? a.setStyle("left", k(n - e.x + p.x + q.width - g - h)) : 0 > d.left + d.width - g - h ? b() :
                0 > d.left + d.width / 2 - g / 2 ? a.setStyle("left", k(n - e.x + p.x)) : a.setStyle("left", k(n + d.width / 2 - g / 2 - h / 2))
        }
    };
    ...
    (function () {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, b) {
                ...
                var n = CKEDITOR.env, p = this._.id = CKEDITOR.tools.getNextId(), g = "", d = this.command, q, k, h;
                this._.editor = a;
                var e = {
                        id: p, button: this, editor: a, focus: function () {
    ...
    (function () {
        ...
        function y(b) {
            function a() {
                ...
                a.on(m.mainPasteEvent, function (b) {
                    "beforepaste" == m.mainPasteEvent && n || t(b)
                });
                "beforepaste" == m.mainPasteEvent && (a.on("paste", function (b) {
                    u || (f(), b.data.preventDefault(), t(b), e("paste"))
            ...
            function c(a) {
                return {
                    ...
                    exec: function () {
                        ...
                        var a;
                        var c = this.type;
                        if (CKEDITOR.env.ie) a = e(c); else try {
            ...
            function d() {
                return {
                    ...
                    86, exec: function (b, a) {
                        ...
                        var e = this, d = "undefined" !== typeof a.notification ? a.notification : !0, g = a.type,
            ...
            function e(a) {
                var c = b.document, d = c.getBody(), e = !1, g = function () {
                    e = !0
                };
                d.on(a, g);
            ...
            function k(a, c) {
                var d = b.document, e = b.editable(), g = function (b) {
                    b.cancel()
                }, h;
            ...
            function t(a) {
                ...
                e && m.canClipboardApiBeTrusted(c.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function () {
                    q(b, c)
                }, 0)) : k(a, function (a) {
            ...
            var m = CKEDITOR.plugins.clipboard, n = 0, u = 0, w = 0;
            (function () {
                b.on("key", l);
                b.on("contentDom", a);
                ...
                b.contextMenu && b.contextMenu.addListener(function (b, a) {
                    ...
                    return {cut: p("cut"), copy: p("copy"), paste: p("paste")}
                })
            })();
            (function () {
        ...
        function A(b, a) {
            function c(b) {
                return CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(b / 2)) + (1 == b % 2 ? "\x3cbr\x3e" : "")
            }
            ...
            a.match(/<div>(<br>|)<\/div>/) && (a = "\x3cp\x3e" + a.replace(/(<div>(<br>|)<\/div>)+/g, function (b) {
                return c(b.split("\x3c/div\x3e\x3cdiv\x3e").length + 1)
            }) + "\x3c/p\x3e"), a = a.replace(/<\/div><div>/g, "\x3cbr\x3e"), a = a.replace(/<\/?div>/g, ""));
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "\x3cbr\x3e")), -1 < a.indexOf("\x3cbr\x3e\x3cbr\x3e") && (a = "\x3cp\x3e" + a.replace(/(<br>){2,}/g, function (b) {
                return c(b.length / 4)
            }) + "\x3c/p\x3e"));
            return B(b, a)
        }
        ...
        function B(b, a) {
            b.enterMode == CKEDITOR.ENTER_BR ? a = a.replace(/(<\/p><p>)+/g, function (b) {
                return CKEDITOR.tools.repeat("\x3cbr\x3e", b.length / 7 * 2)
        ...
        function E(b) {
            ...
            b.on("contentDom", function () {
                ...
                var e = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), k = b.ui.space("top"),
                    v = b.ui.space("bottom");
                ...
                e.attachListener(b, "dragstart", function (c) {
                    a.initDragDataTransfer(c, b)
                }, null, null, 2);
                ...
                e.attachListener(h, "dragover", function (b) {
                    if (CKEDITOR.env.edge) b.data.preventDefault(); else {
                ...
                e.attachListener(h, "drop", function (c) {
                    if (!c.data.$.defaultPrevented) {
                        ...
                        if (!e.isReadOnly() || e.type == CKEDITOR.NODE_ELEMENT && e.is("html")) {
                            var e = a.getRangeAtDropPosition(c, b), g = a.dragRange;
                            e && f(c, g, e)
                        }
                    }
                }, null, null, 9999);
                ...
                e.attachListener(b, "drop", function (e) {
                    if (e = e.data) {
                        var g = e.dropRange, h = e.dragRange, f = e.dataTransfer;
                        f.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
                            setTimeout(function () {
                                a.internalDrop(h, g, f, b)
                            }, 0) : f.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(h, g, f) : d(g, f)
                    }
                }, null, null, 9999)
            })
        }
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "notification,toolbar", init: function (b) {
                var a, c = C();
                ...
                b.on("paste", function (a) {
                    ...
                    if (!a.data.dataValue) {
                        var c = a.data.dataTransfer, d = c.getData("text/html");
                        if (d) a.data.dataValue = d, a.data.type = "html"; else if (d = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(d), a.data.type = "text"
                    }
                }, null, null, 1);
                b.on("paste", function (b) {
                        var a = b.data.dataValue, c = CKEDITOR.dtd.$block;
                        -1 < a.indexOf("Apple-") && (a = a.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi,
                            " "), "html" != b.data.type && (a = a.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi, function (a, b) {
                            return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;")
                        })), -1 < a.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') && (b.data.startsWithEOL = 1, b.data.preSniffing = "html", a = a.replace(/<br class="Apple-interchange-newline">/, "")), a = a.replace(/(<[^>]+) class="Apple-[^"]*"/gi, "$1"));
                        ...
                        CKEDITOR.env.ie ? a = a.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function (a, e) {
                            return e.toLowerCase() in c ? (b.data.preSniffing = "html", "\x3c" + e) : a
                        }) : CKEDITOR.env.webkit ? a = a.replace(/<\/(\w+)><div><br><\/div>$/, function (a, e) {
                            return e in c ? (b.data.endsWithEOL = 1, "\x3c/" + e + "\x3e") : a
                ...
                b.on("paste", function (a) {
                    a = a.data;
                    var e = b._.nextPasteType || a.type, d = a.dataValue, f,
                        n = b.config.clipboard_defaultContentType || "html", l = a.dataTransfer.getTransferType(b);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            canClipboardApiBeTrusted: function (b, a) {
                return b.getTransferType(a) != CKEDITOR.DATA_TRANSFER_EXTERNAL || CKEDITOR.env.chrome && !b.isEmpty() || CKEDITOR.env.gecko && (b.getData("text/html") || b.getFilesCount()) || CKEDITOR.env.safari && 603 <= CKEDITOR.env.version && !CKEDITOR.env.iOS ? !0 : !1
            },
            ...
            internalDrop: function (b, a, c, d) {
                var f = CKEDITOR.plugins.clipboard, g = d.editable(), e, h;
                d.fire("saveSnapshot");
            ...
            getRangeAtDropPosition: function (b,
                                              a) {
                var c = b.data.$, d = c.clientX, f = c.clientY, g = a.getSelection(!0).getRanges()[0],
                    e = a.createRange();
                if (b.data.testRange) return b.data.testRange;
                if (document.caretRangeFromPoint && a.document.$.caretRangeFromPoint(d, f)) c = a.document.$.caretRangeFromPoint(d, f), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), e.collapse(!0); else if (c.rangeParent) e.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), e.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                var p = a.document.$.elementFromPoint(d, f), m = new CKEDITOR.dom.element(p), q;
        ...
        CKEDITOR.plugins.clipboard.dataTransfer = function (b, a) {
            ...
            a && (this.sourceEditor = a, this.setData("text/html", a.getSelectedHtml(1)), "Text" == n || this.getData("text/plain") || this.setData("text/plain", a.getSelection().getSelectedText()))
        };
    ...
    (function () {
        function q(a, e) {
            ...
            k.onClick = l;
            var v = CKEDITOR.tools.addFunction(l), w = CKEDITOR.tools.addFunction(function (c, d) {
                var g = k.idBase, b;
            ...
            a.on("selectionChange", function () {
                ...
                d = d.length;
                for (b = 0; b < d; b++) f = g[b], e = a.lang.elementspath.eleTitle.replace(/%1/, f), f = x.output({
                    id: q + b,
                    label: e,
                    text: f,
    ...
    (function () {
        function w(d) {
            function f(b) {
                ...
                if (r && r.length) for (a = 0; a < r.length; a++) {
                    for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName() in p;) CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(c.document.createText(" ")), b.append(m);
                    b.insertAfter(f)
                }
        ...
        CKEDITOR.plugins.add("indentlist", {
            requires: "indent", init: function (d) {
                function f(d) {
                    ...
                    d.on("key",
                        function (f) {
                            var c = d.elementPath();
                            if ("wysiwyg" == d.mode && f.data.keyCode == this.indentKey && c) {
                                var n = this.getContext(c);
                                !n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, n) || (d.execCommand(this.relatedGlobal), f.cancel())
                            }
                        }, this);
    ...
    (function () {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c, b) {
                ...
                for (d = 0; d < f.length; d++) if (g = a.getRanges()[d], g.shrink(CKEDITOR.SHRINK_TEXT, !1, {skipBogus: !0}), (g = c.elementPath(g.getCommonAncestor()).contains("a", 1)) && b) e.push(g); else if (g) return g;
                return b ? e : null
    ...
    (function () {
        function l(a, c, f) {
            ...
            d ? f() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || c + "filter/default.js"), CKEDITOR.scriptLoader.load(a, f, null, !0));
            return !d
        }
        ...
        CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard", init: function (a) {
                ...
                a.ui.addButton && a.ui.addButton("PasteFromWord",
                    {label: a.lang.pastefromword.toolbar, command: "pastefromword", toolbar: "clipboard,50"});
                a.on("paste", function (d) {
                    var b = d.data,
                        g = (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? b.dataTransfer.getData("text/html", !0) : null) || b.dataValue,
                        e = {dataValue: g},
                        h = /(class=\"?Mso|style=(?:\"|\')[^\"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
                        h = /<meta\s*name=(?:\"|\')?generator(?:\"|\')?\s*content=(?:\"|\')?microsoft/gi.test(g) || h.test(g);
                    if (g && (c || h) && (!1 !== a.fire("pasteFromWord", e) || c)) {
                        b.dontFilter = !0;
                        var k =
                            l(a, f, function () {
                                if (k) a.fire("paste", b); else if (!a.config.pasteFromWordPromptCleanup || c || confirm(a.lang.pastefromword.confirmCleanup)) e.dataValue = CKEDITOR.cleanWord(e.dataValue, a), a.fire("afterPasteFromWord", e), b.dataValue = e.dataValue;
                                c = 0
                            });
                        k && d.cancel()
                    }
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
            ...
            var c = CKEDITOR.plugins.scayt,
                d = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, b = function () {
                    c.destroy(a)
                }, e = function () {
            ...
            "boolean" !== typeof a.config.scayt_inlineModeImmediateMarkup && (a.config.scayt_inlineModeImmediateMarkup =
                !1);
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    ...
                    f = ["lang", "ignore-all-caps-words", "ignore-domain-names", "ignore-words-with-mixed-cases",
                        "ignore-words-with-numbers"], g = CKEDITOR.tools.search, h = CKEDITOR.tools.indexOf;
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], d = 0; d < a.length; d++) {
                        var c = a[d], n = !!g(a, "options");
            ...
            var c = CKEDITOR.plugins.scayt, d = a.dataProcessor, b = d && d.htmlFilter,
                ...
                d = d && d.dataFilter, f = a.addRemoveFormatFilter, g = function (b) {
            ...
            return {
                scayt: {
                    ...
                    grayt_ignoreall: {
                        label: a.getLocal("btn_ignoreAll"),
                        group: "grayt_control", order: 3, exec: function (a) {
            ...
            var d = a.scayt, b = this.scaytMenuDefinition(a), e =
                ...
                g = c.getAttribute(d.getLangAttribute()) || d.getLang(), h, k, m;
            h = d.isScaytNode(c);
            k = d.isGraytNode(c);
            ...
            delete e[l], a.addCommand(l, {exec: b[l].exec}), a.addMenuItem(l, {
            ...
            requires: "richcombo", init: function (c) {
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    onClick: function (b) {
                        ...
                        b = f[b];
                        var a = c.elementPath();
                        if (b.group && b.removeStylesFromSameGroup(c)) c.applyStyle(b); else c[b.checkActive(a, c) ? "removeStyle" : "applyStyle"](b);
                        c.fire("saveSnapshot")
                    },
                    onRender: function () {
                        c.on("selectionChange", function (b) {
                    ...
                    onOpen: function () {
                        var b = c.getSelection().getSelectedElement() || c.editable(), b = c.elementPath(b),
                            a = [0, 0, 0, 0];
                        this.showAll();
                        this.unmarkAll();
                        for (var h in f) {
        ...
        requires: "dialog", init: function (a) {
            function e(b) {
                return CKEDITOR.tools.extend(b || {}, {
                    contextSensitive: 1, refresh: function (b, a) {
                        this.setState(a.contains("table", 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED)
                    }
                })
            }
            ...
            if (!a.blockless) {
                ...
                a.addCommand("table", new CKEDITOR.dialogCommand("table", {
                    ...
                    contentTransformations: [["table{width}: sizeToStyle", "table[width]: sizeToAttribute"], ["td: splitBorderShorthand"], [{
                        element: "table",
                        right: function (b) {
                            b.styles && (b.styles.border && b.styles.border.match(/solid/) && (b.attributes.border = 1), "collapse" == b.styles["border-collapse"] && (b.attributes.cellspacing = 0))
                        }
                    }]]
                }));
                ...
                a.addCommand("tableDelete", e({
                    exec: function (b) {
                        ...
                        if (a) {
                            var d = a.getParent(), c = b.editable();
                ...
                a.addMenuItems && a.addMenuItems({
                    table: {
                        label: c.menu,
                        command: "tableProperties", group: "table", order: 5
    ...
    (function () {
        function q(d, e) {
            function b(a) {
                return e ? e.contains(a) && a.getAscendant("table", !0).equals(e) : !0
            }

            function c(b) {
                0 < f.length || b.type != CKEDITOR.NODE_ELEMENT || !H.test(b.getName()) || b.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(a, b, "selected_cell", !0), f.push(b))
            }

            var f = [], a = {};
            if (!d) return f;
            for (var h = d.getRanges(), k = 0; k < h.length; k++) {
                var g = h[k];
                if (g.collapsed) (g = g.getCommonAncestor().getAscendant({
                    td: 1,
                    th: 1
                }, !0)) && b(g) && f.push(g); else {
                    var g = new CKEDITOR.dom.walker(g), l;
                    for (g.guard =
                             c; l = g.next();) l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
                        td: 1,
                        th: 1
                    }, !0)) && !l.getCustomData("selected_cell") && b(l) && (CKEDITOR.dom.element.setMarker(a, l, "selected_cell", !0), f.push(l))
                }
            }
        ...
        function t(d, e) {
            for (var b = G(d) ? d : q(d), c = b[0], f = c.getAscendant("table"), c = c.getDocument(), a = b[0].getParent(), h = a.$.rowIndex, b = b[b.length - 1], k = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(f.$.rows[k]), h = e ? h : k, a = e ? a : b,
                     b = CKEDITOR.tools.buildTableMap(f), f = b[h], h = e ? b[h - 1] : b[h + 1], b = b[0].length, c = c.createElement("tr"), k = 0; f[k] && k < b; k++) {
                var g;
                1 < f[k].rowSpan && h && f[k] == h[k] ? (g = f[k], g.rowSpan += 1) : (g = (new CKEDITOR.dom.element(f[k])).clone(), g.removeAttribute("rowSpan"), g.appendBogus(), c.append(g), g = g.$);
                k += g.colSpan - 1
            }
            e ? c.insertBefore(a) : c.insertAfter(a);
            return c
        }

        function D(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                var e = d.getRanges(), b = q(d), c = b[0].getAscendant("table"), f = CKEDITOR.tools.buildTableMap(c),
                    a = b[0].getParent().$.rowIndex,
                    b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = [];
                d.reset();
                for (d = a; d <= h; d++) {
                    for (var k = f[d], g = new CKEDITOR.dom.element(c.$.rows[d]), l = 0; l < k.length; l++) {
                        var r = new CKEDITOR.dom.element(k[l]), n = r.getParent().$.rowIndex;
                        1 == r.$.rowSpan ? r.remove() : (--r.$.rowSpan, n == d && (n = f[d + 1], n[l - 1] ? r.insertAfter(new CKEDITOR.dom.element(n[l - 1])) : (new CKEDITOR.dom.element(c.$.rows[d + 1])).append(r, 1)));
                        l += r.$.colSpan - 1
                    }
                    b.push(g)
                }
                f = c.$.rows;
                e[0].moveToPosition(c, CKEDITOR.POSITION_BEFORE_START);
                a = new CKEDITOR.dom.element(f[h +
                1] || (0 < a ? f[a - 1] : null) || c.$.parentNode);
                for (d = b.length; 0 <= d; d--) D(b[d]);
                return c.$.parentNode ? a : (e[0].select(), null)
            }
        ...
        function B(d, e) {
            for (var b = d.getParent().$.cells, c = 0, f = 0; f < b.length; f++) {
                var a = b[f], c = c + (e ? 1 : a.colSpan);
                if (a == d.$) break
            }
            return c - 1
        }
        ...
        function w(d, e) {
            for (var b = e ? Infinity : 0, c = 0; c < d.length; c++) {
                var f = B(d[c], e);
                if (e ? f < b : f > b) b = f
            }
            return b
        ...
        function p(d, e) {
            for (var b = G(d) ? d : q(d),
                     c = b[0].getAscendant("table"), f = w(b, 1), b = w(b), a = e ? f : b, h = CKEDITOR.tools.buildTableMap(c), c = [], f = [], b = [], k = h.length, g = 0; g < k; g++) c.push(h[g][a]), f.push(e ? h[g][a - 1] : h[g][a + 1]);
            for (g = 0; g < k; g++) c[g] && (1 < c[g].colSpan && f[g] == c[g] ? (h = c[g], h.colSpan += 1) : (a = new CKEDITOR.dom.element(c[g]), h = a.clone(), h.removeAttribute("colSpan"), h.appendBogus(), h[e ? "insertBefore" : "insertAfter"].call(h, a), b.push(h), h = h.$), g += h.rowSpan - 1);
            return b
        }
        ...
        function m(d, e) {
            ...
            if (b) {
                var c =
                    b.clone();
                c.appendBogus();
                e ? c.insertBefore(b) : c.insertAfter(b)
            }
        }

        function v(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                var e = d.getRanges(), b = q(d), c = b[0] && b[0].getAscendant("table"), f;
                a:{
                    var a = 0;
                    f = b.length - 1;
                    for (var h = {}, k, g; k = b[a++];) CKEDITOR.dom.element.setMarker(h, k, "delete_cell", !0);
                    for (a = 0; k = b[a++];) if ((g = k.getPrevious()) && !g.getCustomData("delete_cell") || (g = k.getNext()) && !g.getCustomData("delete_cell")) {
                    ...
                    CKEDITOR.dom.element.clearAllMarkers(h);
                    a = b[0].getParent();
                    (a = a.getPrevious()) ? f = a.getLast() : (a = b[f].getParent(), f = (a = a.getNext()) ? a.getChild(0) : null)
                }
                d.reset();
                for (d = b.length - 1; 0 <= d; d--) v(b[d]);
                f ? x(f, !0) : c && (e[0].moveToPosition(c, CKEDITOR.POSITION_BEFORE_START), e[0].select(), c.remove())
            } else d instanceof CKEDITOR.dom.element && (e = d.getParent(), 1 == e.getChildCount() ? e.remove() : d.remove())
        }
        ...
        function x(d, e) {
            ...
            b["moveToElementEdit" + (e ? "End" : "Start")](d) || (b.selectNodeContents(d), b.collapse(e ? !1 : !0));
            b.select(!0)
        }
        ...
        function y(d, e, b) {
            ...
            for (e = 0; d && e < d.length; e++) {
                if (b.is && d[e] == b.$) return e;
                if (e == b) return new CKEDITOR.dom.element(d[e])
            }
            return b.is ? -1 : null
        }
        ...
        function z(d, e, b) {
            var c = q(d), f;
            if ((e ? 1 != c.length : 2 > c.length) || (f = d.getCommonAncestor()) && f.type == CKEDITOR.NODE_ELEMENT && f.is("table")) return !1;
            var a;
            d = c[0];
            f = d.getAscendant("table");
            var h = CKEDITOR.tools.buildTableMap(f),
                k = h.length, g = h[0].length, l = d.getParent().$.rowIndex, r = y(h, l, d);
            if (e) {
                var n;
                try {
                    var C = parseInt(d.getAttribute("rowspan"), 10) || 1;
                    a = parseInt(d.getAttribute("colspan"), 10) || 1;
                    n = h["up" == e ? l - C : "down" == e ? l + C : l]["left" == e ? r - a : "right" == e ? r + a : r]
                } catch (x) {
                    return !1
                }
                if (!n || d.$ == n) return !1;
                c["up" == e || "left" == e ? "unshift" : "push"](new CKEDITOR.dom.element(n))
            }
            e = d.getDocument();
            var E = l, C = n = 0, u = !b && new CKEDITOR.dom.documentFragment(e), t = 0;
            for (e = 0; e < c.length; e++) {
                a = c[e];
                var p = a.getParent(), w = a.getFirst(), m = a.$.colSpan,
                    v = a.$.rowSpan, p = p.$.rowIndex, z = y(h, p, a), t = t + m * v, C = Math.max(C, z - r + m);
                n = Math.max(n, p - l + v);
                b || (m = a, (v = m.getBogus()) && v.remove(), m.trim(), a.getChildren().count() && (p == E || !w || w.isBlockBoundary && w.isBlockBoundary({br: 1}) || (E = u.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !E || E.is && E.is("br") || u.append("br")), a.moveChildren(u)), e ? a.remove() : a.setHtml(""));
                E = p
            }
            if (b) return n * C == t;
            u.moveChildren(d);
            d.appendBogus();
            C >= g ? d.removeAttribute("rowSpan") : d.$.rowSpan = n;
            n >= k ? d.removeAttribute("colSpan") : d.$.colSpan =
                C;
            b = new CKEDITOR.dom.nodeList(f.$.rows);
            c = b.count();
            for (e = c - 1; 0 <= e; e--) f = b.getItem(e), f.$.cells.length || (f.remove(), c++);
            return d
        }
        ...
        function A(d, e) {
            ...
            if (e) return !0;
            var b = b[0], c = b.getParent(), f = c.getAscendant("table"), a = CKEDITOR.tools.buildTableMap(f),
                h = c.$.rowIndex, k = y(a, h, b), g = b.$.rowSpan, l;
            if (1 < g) {
                l = Math.ceil(g / 2);
                for (var g = Math.floor(g / 2), c = h + l, f = new CKEDITOR.dom.element(f.$.rows[c]), a = y(a, c), r, c = b.clone(), h = 0; h < a.length; h++) if (r = a[h], r.parentNode == f.$ && h > k) {
                    c.insertBefore(new CKEDITOR.dom.element(r));
                    break
                } else r = null;
                r || f.append(c)
            } else for (g = l = 1, f = c.clone(), f.insertAfter(c), f.append(c = b.clone()), r = y(a, h), k = 0; k < r.length; k++) r[k].rowSpan++;
            c.appendBogus();
            b.$.rowSpan = l;
            c.$.rowSpan = g;
        ...
        function F(d, e) {
            ...
            if (1 < b.length) return !1;
            if (e) return !0;
            var b = b[0], c = b.getParent(), f = c.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(f),
                a = y(f, c.$.rowIndex, b), h = b.$.colSpan;
            if (1 < h) c = Math.ceil(h / 2), h = Math.floor(h / 2); else {
                for (var h =
                    c = 1, k = [], g = 0; g < f.length; g++) {
                    var l = f[g];
                    k.push(l[a]);
                    1 < l[a].rowSpan && (g += l[a].rowSpan - 1)
                }
        ...
        var H = /^(?:td|th)$/, G = CKEDITOR.tools.isArray;
        CKEDITOR.plugins.tabletools = {
            requires: "table,dialog,contextmenu", init: function (d) {
                ...
                var c = d.lang.table, f = CKEDITOR.tools.style.parse;
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", e({
                    allowedContent: "td th{width,height,border-color,background-color,white-space,vertical-align,text-align}[colspan,rowspan]",
                    requiredContent: "table",
                    contentTransformations: [[{
                        element: "td", left: function (a) {
                            return a.styles.background && f.background(a.styles.background).color
                        },
                        right: function (a) {
                            a.styles["background-color"] = f.background(a.styles.background).color
                        }
                    }, {
                ...
                b("columnDelete", e({
                    requiredContent: "table", exec: function (a) {
                        var b = a.getSelection();
                        a = b.getRanges();
                        var c = q(b), d = c[0], e = c[c.length - 1], c = d.getAscendant("table"),
                            f = CKEDITOR.tools.buildTableMap(c), n, p, t = [];
                        b.reset();
                        for (var m = 0, b = f.length; m < b; m++) for (var u = 0, v = f[m].length; u < v; u++) f[m][u] == d.$ && (n = u), f[m][u] == e.$ && (p = u);
                        for (m = n; m <= p; m++) for (u = 0; u < f.length; u++) e = f[u], d = new CKEDITOR.dom.element(c.$.rows[u]),
                            e = new CKEDITOR.dom.element(e[m]), e.$ && (1 == e.$.colSpan ? e.remove() : --e.$.colSpan, u += e.$.rowSpan - 1, d.$.cells.length || t.push(d));
                        p = c.$.rows[0] && c.$.rows[0].cells;
                        n = new CKEDITOR.dom.element(p[n] || (n ? p[n - 1] : c.$.parentNode));
                        t.length == b && (a[0].moveToPosition(c, CKEDITOR.POSITION_AFTER_END), a[0].select(), c.remove());
                        n && x(n, !0)
                    }
                }));
                b("columnInsertBefore", e({
                    requiredContent: "table", exec: function (a) {
                        a = a.getSelection();
                        a = q(a);
                        p(a, !0)
                ...
                b("cellMergeDown", e({
                    allowedContent: "td[rowspan]", requiredContent: "td[rowspan]", exec: function (a,
                                                                                                   b) {
                        b.cell = z(a.getSelection(), "down");
                        x(b.cell, !0)
                    }
                }));
                b("cellVerticalSplit", e({
                ...
                d.addMenuItems({
                    tablecell: {
                        label: c.cell.menu, group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_merge: z(a, null, !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                                tablecell_merge_right: z(a, "right", !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                                tablecell_merge_down: z(a, "down", !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                                tablecell_split_vertical: F(a, !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                    ...
                    tablecell_delete: {
                        label: c.cell.deleteCell, group: "tablecell",
                        command: "cellDelete", order: 15
                    },
                    ...
                    tablecell_split_vertical: {
                        label: c.cell.splitVertical, group: "tablecell", command: "cellVerticalSplit",
                        order: 20
                    },
                    ...
                    tablerow_insertAfter: {
                        label: c.row.insertAfter, group: "tablerow", command: "rowInsertAfter",
                        order: 10
                    },
                    ...
                    tablecolumn_insertAfter: {
                        label: c.column.insertAfter, group: "tablecolumn",
                        command: "columnInsertAfter", order: 10
                    },
                    tablecolumn_delete: {
            ...
            }, getCellColIndex: B, insertRow: t, insertColumn: p, getSelectedCells: q
        };
        CKEDITOR.plugins.add("tabletools", CKEDITOR.plugins.tabletools)
    })();
    CKEDITOR.tools.buildTableMap = function (q, t, D, B, w) {
        q = q.$.rows;
        D = D || 0;
        B = "number" === typeof B ? B : q.length - 1;
        w = "number" === typeof w ? w : -1;
        var p = -1, m = [];
        for (t = t || 0; t <= B; t++) {
            p++;
            !m[p] && (m[p] = []);
            for (var v = -1, x = D; x <= (-1 === w ? q[t].cells.length - 1 : w); x++) {
                var y = q[t].cells[x];
                if (!y) break;
                for (v++; m[p][v];) v++;
                for (var z = isNaN(y.colSpan) ? 1 : y.colSpan, y = isNaN(y.rowSpan) ? 1 : y.rowSpan, A = 0; A < y && !(t + A > B); A++) {
                    m[p + A] || (m[p + A] = []);
                    for (var F = 0; F < z; F++) m[p + A][v + F] = q[t].cells[x]
                }
                v += z - 1;
                if (-1 !== w && v >= w) break
            }
    ...
    (function () {
        function x(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c), k = n(a),
                m = n(b), l = [], h = {}, f, p;
            c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), m = n(b));
            k > m && (c = k, k = m, m = c, c = a, a = b, b = c);
            for (c = 0; c < e[k].length; c++) if (a.$ === e[k][c]) {
                f = c;
                break
            }
            for (c = 0; c < e[m].length; c++) if (b.$ === e[m][c]) {
                p = c;
                break
            }
            f > p && (c = f, f = p, p = c);
            for (c = k; c <= m; c++) for (k = f; k <= p; k++) d = new CKEDITOR.dom.element(e[c][k]), d.$ && !d.getCustomData("selected_cell") && (l.push(d), CKEDITOR.dom.element.setMarker(h,
                d, "selected_cell", !0));
            CKEDITOR.dom.element.clearAllMarkers(h);
            return l
        }
        ...
        function J(a) {
            var b =
                a.editable().find(".cke_table-faked-selection");
            1 > b.count() || (b = x(b.getItem(0), b.getItem(b.count() - 1)), t(a, b))
        }
        ...
        function K(a, b, c) {
            ...
            if (e) g.first = b || d[0], g.dirty = b ? !1 : 1 !== d.length; else if (g.active && b && g.first.getAscendant("table").equals(b.getAscendant("table"))) {
                d = x(g.first, b);
                if (!g.dirty && 1 === d.length) return y(a, "mouseup" === c.name);
                g.dirty =
                    !0;
                g.last = b;
                t(a, d)
        ...
        function L(a) {
            var b = (a = a.editor || a.sender.editor) && a.getSelection(), c = b && b.getRanges() || [], d;
        ...
        function v(a) {
            ...
            function d(a, d, e, h) {
                return "mousedown" === a.name && (z(a) || !h) || "mouseup" === a.name && !c(a.data.getTarget()) && !b(e, h) ? !0 : !1
            }

            if (a.data.getTarget().getName) {
                var e = a.editor || a.listenerData.editor, k = e.getSelection(1), m = I(e), l = a.data.getTarget(),
                    h = l && l.getAscendant({
                        td: 1,
                        th: 1
                    }, !0), l = l && l.getAscendant("table", !0),
                    f = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
                d(a, k, m, l) && y(e, !0);
                !g.active && "mousedown" === a.name && z(a) && l && (g = {active: !0}, CKEDITOR.document.on("mouseup", v, null, {editor: e}));
                (h || l) && K(e, h || l, a);
                "mouseup" === a.name && (z(a) && (c(a.data.getTarget()) || b(m, l)) && J(e), g = {active: !1}, CKEDITOR.document.removeListener("mouseup", v))
            }
        }
        ...
        function N(a, b) {
            ...
            var d = a.getSelection(), e = d.createBookmarks(), k = a.document, m = a.createRange(),
                l = k.getDocumentElement().$, h = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
                f = a.blockless || CKEDITOR.env.ie ? "span" : "div", p, r, C, g;
            k.getById("cke_table_copybin") || (p = k.createElement(f), r = k.createElement(f), r.setAttributes({
                ...
                "left" : "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), r.append(p), a.editable().append(r), g = a.on("selectionChange", c, null, null, 0), h && (C = l.scrollTop), m.selectNodeContents(p), m.select(), h && (l.scrollTop = C), setTimeout(function () {
                r.remove();
                d.selectBookmarks(e);
                g.removeListener();
                a.fire("unlockSnapshot");
        ...
        q.prototype.getTableMap = function () {
            var a = B(this.cells.first, !0), b;
            a:{
                b = this.cells.last;
                var c = b.getAscendant("table"), d = n(b), c = CKEDITOR.tools.buildTableMap(c), e;
            ...
            return CKEDITOR.tools.buildTableMap(this._getTable(), n(this.rows.first), a, n(this.rows.last),
                b)
        };
        ...
        q.prototype.insertRow = function (a, b, c) {
            ...
            for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, k = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = E(c ? this.cells.all : k, b), m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(), function (a) {
                return c ? !0 : a.$.cellIndex >= d && a.$.cellIndex <= e
            }), k = b ? m.concat(k) : k.concat(m);
            this.setSelectedCells(k)
        };
        q.prototype.insertColumn = function (a) {
            ...
            if ("undefined" === typeof a) a = 1; else if (0 >= a) return;
            for (var c = this.cells, d = c.all, e = n(c.first), k = n(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(F(d), b));
        ...
        var G = {
            onPaste: function (a) {
                ...
                var d = a.editor, e = d.getSelection(), k = u(e),
                    m = this.findTableInPastedContent(d, a.data.dataValue),
                    l = e.isInTable(!0) && this.isBoundarySelection(e), h, f;
                !k.length || 1 === k.length && !H(e.getRanges()[0]) && !l || l && !m || (k = k[0].getAscendant("table"), h = new q(u(e, k)), d.once("afterPaste", function () {
                    var a;
                    if (f) {
                        a = new CKEDITOR.dom.element(f[0][0]);
                        var b = f[f.length - 1];
                        a = x(a, new CKEDITOR.dom.element(b[b.length -
                        1]))
                    } else a = h.cells.all;
                    t(d, a)
                }), m ? (a.stop(), l ? (h.insertRow(1, 1 === l, !0), e.selectElement(h.rows.first)) : (h.emptyCells(), t(d, h.cells.all)), a = h.getTableMap(), f = CKEDITOR.tools.buildTableMap(m), h.insertRow(f.length - a.length), h.insertColumn(b(f) - b(a)), a = h.getTableMap(), this.pasteTable(h, a, f), d.fire("saveSnapshot"), setTimeout(function () {
                    d.fire("afterPaste")
                }, 0)) : (c(h.cells.first), d.once("afterPaste", function () {
                    d.fire("lockSnapshot");
                    h.emptyCells(h.cells.all.slice(1));
                    t(d, h.cells.all);
                    d.fire("unlockSnapshot")
                })))
            },
            isBoundarySelection: function (a) {
                ...
                var d, e = B(a.cells.first,
                    !0), k = a._getTable(), m = {}, l, h, f, p;
                for (f = 0; f < c.length; f++) for (l = new CKEDITOR.dom.element(k.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++) if (h = new CKEDITOR.dom.element(c[f][p]), d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null, h && !h.getCustomData("processed")) {
                    if (d && d.getParent()) h.replace(d); else if (0 === p || c[f][p - 1]) (d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) && l.equals(d.getParent()) ? h.insertAfter(d) : 0 < e ? l.$.cells[e] ? h.insertAfter(new CKEDITOR.dom.element(l.$.cells[e])) : l.append(h) :
                        l.append(h, !0);
                    CKEDITOR.dom.element.setMarker(m, h, "processed", !0)
            ...
            getCellsBetween: x, keyboardIntegration: function (a) {
                ...
                c.attachListener(c, "keydown", function (a) {
                    function c(b, e) {
                        ...
                        var f =
                            a.createRange(), k = CKEDITOR.dom.range.mergeRanges(e);
                        CKEDITOR.tools.array.forEach(k, function (a) {
                            a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
                        });
                        var r = k[0].getBoundaryNodes(), g = r.startNode, r = r.endNode;
                        if (g && g.is && g.is(m)) {
                            ...
                            }; n && !u(n);) n = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                            !n && r && r.is && !r.is("table") && r.getNext() && (n = r.getNext().findOne("td, th"),
                                t = !0);
                            if (n) f["moveToElementEdit" + (t ? "Start" : "End")](n); else f.setStartBefore(g.getAscendant("table", !0)), f.collapse(!0);
                            k[0].deleteContents();
                            return [f]
                        }
                    ...
                    var k = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1},
                        m = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
                    delete m.td;
                    delete m.th;
                    return function (l) {
                        var h = l.data.getKey(), f, m = 37 === h || 38 == h, g, n, q;
                        if (k[h] && (f = a.getSelection()) && f.isInTable() && f.isFake) if (g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length -
                            1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < h && 46 > h) g[0].moveToElementEditablePosition(m ? n : q, !m), f.selectRanges([g[0]]); else {
                ...
                c.attachListener(c, "keypress", function (d) {
                    var c = a.getSelection(), k = d.data.$.charCode || 13 === d.data.getKey(), g;
                    if (c && c.isInTable() && c.isFake && k && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
                        d = c.getRanges();
                        k = d[0].getEnclosedNode().getAscendant({
                            td: 1,
                            th: 1
                        }, !0);
                        for (g = 0; g < d.length; g++) b(d[g]);
                        d[0].moveToElementEditablePosition(k);
                        c.selectRanges([d[0]])
                    }
                }, null, null, -1)
            ...
            requires: "clipboard,tabletools", onLoad: function () {
                ...
                (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function () {
                    ...
                    CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b,
                        "cut", D), b.attachListener(b, "copy", D))
                }), a.on("paste", G.onPaste, G), A(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, c) {
                    t(a, c.selectedCells)
                }), A(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, c) {
