                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal tasi-form" method="get">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <a class="btn btn-success" data-toggle="modal" href="#myModal">انتخاب تصویر شاخص
                                                        </a>
                                                        <a class="btn btn-danger" style="display: none" id="imgRemover" onclick="deletImg()"> حذف تصویر شاخص</a>
                                                                ...
                                                                <section class="panel">
                                                                    <header class="panel-heading tab-bg-dark-navy-blue">
                                                                        <ul class="nav nav-tabs">
                                                                            ...
                                                                            <li class="">
                                                                                <a data-toggle="tab" href="#about-2" id="folder">
                                                                            ...
                                                                            <div id="home-2" class="tab-pane active" style="">
                                                                                <div class="form-group">
                                                                                    <div class="image-editor" style="text-align: center;direction: ltr;">
                                                                                        <div class="col-md-12">
                                                                                        <img src="" id="blah" class="col-md-7" style="float: none;margin: auto">
                                                                                        </div>
                                                                                        <br>
                                                                                        <input type="file" class="" style="display:none;" id="img" accept="image/jpeg">
                                                                                        <a type="button" onclick="$('#img').click();" class="btn btn-info "><i class="icon-plus"></i> اضافه کردن تصویر</a>
                                                                                        <br>
                                                                                        <br>
                                                                                        <button  class="btn btn-primary" onclick="upload();" type="button">بارگزاری</button>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <section class="panel">
                                                            ...
                                                            <div class="alert alert-success fade in" id="successMSG" style="display: none" >
                                                                ...
                                                                مطلب با موفقیت در سیستم اضافه شد.
                                                            </div>
                                                            <div class="panel-body">
                                                                <div class="form">
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data['error'] === false) {
                ...
                var cot = "'";
                var html = '<img id="amir23" src="../img/'+address+'" ondblclick="selectImg('+cot+id+cot+','+cot+'../img/'+address+cot+')" class="col-md-3" style="margin-bottom:5px;cursor: pointer;height: 50px;">';
