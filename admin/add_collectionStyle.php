                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form">
                                                                    <form action="#" class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control ckeditor" name="TOP" id="TOP" rows="6"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form">
                                                                    <form action="#" class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control ckeditor" name="TEXT" id="TEXT" rows="6"></textarea>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form">
                                                                    <form action="#" class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control ckeditor" name="BOTTOM" id="BOTTOM" rows="6"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form">
                                                                    <form action="#" class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-10">
                                                                                <textarea class="form-control ckeditor" name="COUNT" id="COUNT" rows="6"></textarea>
...
function submit_post() {
    ...
    if(y===0){
        ...
        $.ajax({
            url: 'ajax/addCollectionStyle.php',
            data: {
                number:number,
                name:name,
                bottom:BOTTOM,
